...
.field private static final Xd:Z = false

.field private static Yd:Z = false

.field private static final Zd:Ljava/lang/String; = "ProcessManagement"

.field private static _d:Landroid/util/ArrayMap;
...
.field private static ae:Landroid/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/ArrayMap<",
            "Ljava/lang/String;",
...
.field private static be:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field private static ce:Ljava/lang/Object;
...
.field private Sd:Landroid/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/ArrayMap<",
...
.field private Ud:Landroid/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/ArrayMap<",
            "Ljava/lang/String;",
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/cjf;->Yd:Z

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    sput-object v0, Lcom/android/server/cjf;->_d:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    sput-object v0, Lcom/android/server/cjf;->ae:Landroid/util/ArrayMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/android/server/cjf;->be:Ljava/util/List;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/android/server/cjf;->ce:Ljava/lang/Object;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/cjf;->Sd:Landroid/util/ArrayMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/cjf;->Td:Ljava/util/ArrayList;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/cjf;->Ud:Landroid/util/ArrayMap;

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/cjf;->Vd:Landroid/util/ArrayMap;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lcom/android/server/cjf;->Wd:Ljava/lang/Object;
...
.method static synthetic access$300()Z
    ...
    sget-boolean v0, Lcom/android/server/cjf;->Yd:Z
...
.method static synthetic sis(Lcom/android/server/cjf;)Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    iget-object p0, p0, Lcom/android/server/cjf;->Qd:Lcom/android/server/AlarmManagerService$AmsInner;
...
.method private you(Ljava/lang/String;ZI)V
    ...
    sget-object p2, Lcom/android/server/cjf;->ce:Ljava/lang/Object;

    monitor-enter p2

    :try_start_0
    sget-object p0, Lcom/android/server/cjf;->_d:Landroid/util/ArrayMap;
    ...
    sget-object p0, Lcom/android/server/cjf;->ae:Landroid/util/ArrayMap;
    ...
    iget-object p3, p0, Lcom/android/server/cjf;->Qd:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    sget-object p0, Lcom/android/server/cjf;->ce:Ljava/lang/Object;

    monitor-enter p0

    :try_start_1
    sget-object p2, Lcom/android/server/cjf;->_d:Landroid/util/ArrayMap;

    invoke-virtual {p2, p1}, Landroid/util/ArrayMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    sget-object p2, Lcom/android/server/cjf;->ae:Landroid/util/ArrayMap;
...
.method private zta(Lcom/android/server/AlarmManagerService$Alarm;JJ)Z
    ...
    sget-object v0, Lcom/android/server/cjf;->ce:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/android/server/cjf;->_d:Landroid/util/ArrayMap;
    ...
    iget-object v1, p0, Lcom/android/server/cjf;->Td:Ljava/util/ArrayList;
    ...
    iget-object p2, p0, Lcom/android/server/cjf;->Qd:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    :cond_3
    iget-object p2, p0, Lcom/android/server/cjf;->Td:Ljava/util/ArrayList;
    ...
    iget-object p2, p0, Lcom/android/server/cjf;->Wd:Ljava/lang/Object;

    monitor-enter p2

    :try_start_1
    iget-object p3, p0, Lcom/android/server/cjf;->Sd:Landroid/util/ArrayMap;
    ...
    iget-object p1, p0, Lcom/android/server/cjf;->Vd:Landroid/util/ArrayMap;
    ...
    iget-object p0, p0, Lcom/android/server/cjf;->Vd:Landroid/util/ArrayMap;
    ...
    :cond_5
    iget-object p2, p0, Lcom/android/server/cjf;->Vd:Landroid/util/ArrayMap;
    ...
    iget-object p0, p0, Lcom/android/server/cjf;->Td:Ljava/util/ArrayList;
...
.method public deliverDelayAlarm(Landroid/os/Message;)V
    ...
    iget-object v3, p0, Lcom/android/server/cjf;->Wd:Ljava/lang/Object;
    ...
    :goto_0
    :try_start_0
    iget-object v6, p0, Lcom/android/server/cjf;->Sd:Landroid/util/ArrayMap;
    ...
    iget-object v3, p0, Lcom/android/server/cjf;->Qd:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    iget-object v0, p0, Lcom/android/server/cjf;->Wd:Ljava/lang/Object;
    ...
    iget-object v3, p0, Lcom/android/server/cjf;->Sd:Landroid/util/ArrayMap;
    ...
    :goto_2
    iget-object v1, p0, Lcom/android/server/cjf;->Vd:Landroid/util/ArrayMap;
    ...
    iget-object v5, p0, Lcom/android/server/cjf;->Td:Ljava/util/ArrayList;

    invoke-virtual {v5, v3}, Ljava/util/ArrayList;->remove(Ljava/lang/Object;)Z

    iget-object v5, p0, Lcom/android/server/cjf;->Ud:Landroid/util/ArrayMap;
...
.method public dma(Z)Z
    ...
    sget-boolean p0, Lcom/android/server/cjf;->Yd:Z

    sput-boolean p1, Lcom/android/server/cjf;->Yd:Z
...
.method public initInstance(Lcom/android/server/AlarmManagerService$AmsInner;Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/android/server/cjf;->Qd:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    iget-object v0, p0, Lcom/android/server/cjf;->Qd:Lcom/android/server/AlarmManagerService$AmsInner;
...
.method rtg(J)J
    ...
    iget-wide v0, p0, Lcom/android/server/cjf;->Rd:J
...
.method public setAlarmAlignment(Lcom/android/server/AlarmManagerService$Alarm;Lcom/android/server/AlarmManagerService$AlarmAlignmentReason;JJ)Z
    ...
    sget-object v2, Lcom/android/server/oxb;->Ad:[I
    ...
    :cond_8
    iget-object v1, p0, Lcom/android/server/cjf;->Qd:Lcom/android/server/AlarmManagerService$AmsInner;
...
.method public setBlackAlarm(Ljava/util/List;)V
    ...
    sget-object p0, Lcom/android/server/cjf;->be:Ljava/util/List;
    ...
    sget-object p1, Lcom/android/server/cjf;->be:Ljava/util/List;
...
.method public updateInteractiveStartTime(J)V
    ...
    iput-wide p1, p0, Lcom/android/server/cjf;->Rd:J
