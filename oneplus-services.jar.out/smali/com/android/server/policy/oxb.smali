...
.field private static final eF:I = 0x9c4

.field static final fF:F = 2.5f

.field static final gF:I = 0xc9

.field static final hF:I = 0xca

.field static final iF:I = 0xcb

.field static final jF:J = 0xbb8L

.field private static final kF:J = 0x78L

.field private static final lF:I = 0x3

.field private static final mF:I = 0x5

.field static final nF:I = 0x0

.field static final oF:I = 0x1

.field static final pF:I = 0x2

.field static final qF:I = 0x3

.field private static final rF:Landroid/net/Uri;

.field private static final sF:I = 0x0

.field private static final tF:I = 0x1


# instance fields
.field UE:Lcom/android/server/policy/PhoneWindowManager;
...
.field aF:Lcom/android/server/GestureLauncherService;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/policy/oxb;->rF:Landroid/net/Uri;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/server/policy/oxb;->VE:Z

    iput-boolean v0, p0, Lcom/android/server/policy/oxb;->WE:Z

    iput v0, p0, Lcom/android/server/policy/oxb;->XE:I

    iput-boolean v0, p0, Lcom/android/server/policy/oxb;->ZE:Z

    iput v0, p0, Lcom/android/server/policy/oxb;->cF:I

    iput v0, p0, Lcom/android/server/policy/oxb;->dF:I

    return-void
.end method

.method private _n()Landroid/content/ComponentName;
    .locals 5
    ...
    iget-object v2, p0, Lcom/android/server/policy/oxb;->UE:Lcom/android/server/policy/PhoneWindowManager;
...
.method private bo()V
    ...
    iget-boolean v0, p0, Lcom/android/server/policy/oxb;->VE:Z
    ...
    :cond_0
    iget v0, p0, Lcom/android/server/policy/oxb;->XE:I
    ...
    :cond_2
    iput v3, p0, Lcom/android/server/policy/oxb;->XE:I

    iget-object v0, p0, Lcom/android/server/policy/oxb;->UE:Lcom/android/server/policy/PhoneWindowManager;

    iput-boolean v3, v0, Lcom/android/server/policy/PhoneWindowManager;->mPowerKeyHandled:Z

    iget-boolean v4, p0, Lcom/android/server/policy/oxb;->WE:Z
    ...
    :cond_3
    invoke-direct {p0}, Lcom/android/server/policy/oxb;->_n()Landroid/content/ComponentName;
    ...
    :goto_0
    iget v2, p0, Lcom/android/server/policy/oxb;->YE:I
    ...
    :cond_7
    iput-boolean v3, p0, Lcom/android/server/policy/oxb;->ZE:Z
    ...
    iget-boolean v2, p0, Lcom/android/server/policy/oxb;->WE:Z
    ...
    :cond_c
    iget-boolean v0, p0, Lcom/android/server/policy/oxb;->WE:Z
    ...
    :cond_f
    :goto_5
    iput-boolean v1, p0, Lcom/android/server/policy/oxb;->ZE:Z

    iget-object p0, p0, Lcom/android/server/policy/oxb;->UE:Lcom/android/server/policy/PhoneWindowManager;
...
.method static synthetic zta(Lcom/android/server/policy/oxb;)V
    ...
    invoke-direct {p0}, Lcom/android/server/policy/oxb;->bo()V
...
.method public synthetic Oc()V
    ...
    iget p0, p0, Lcom/android/server/policy/oxb;->YE:I
...
.method public handleEmergency(Landroid/util/MutableBoolean;)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/policy/oxb;->_E:Z
    ...
    :cond_0
    iget v0, p0, Lcom/android/server/policy/oxb;->cF:I
    ...
    iput-boolean v1, p0, Lcom/android/server/policy/oxb;->_E:Z
    ...
    :cond_5
    :goto_1
    iget p0, p0, Lcom/android/server/policy/oxb;->cF:I
...
.method public init(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/policy/PhoneWindowManager;)V
    ...
    iput-object p3, p0, Lcom/android/server/policy/oxb;->UE:Lcom/android/server/policy/PhoneWindowManager;

    iget-object p1, p0, Lcom/android/server/policy/oxb;->UE:Lcom/android/server/policy/PhoneWindowManager;
...
.method public initGestureLauncherService(Lcom/android/server/GestureLauncherService;)V
    ...
    iput-object p1, p0, Lcom/android/server/policy/oxb;->aF:Lcom/android/server/GestureLauncherService;
...
.method public interceptPowerKeyDown(Landroid/view/KeyEvent;)Z
    ...
    iput v2, p0, Lcom/android/server/policy/oxb;->XE:I
    ...
    iput p1, p0, Lcom/android/server/policy/oxb;->YE:I
...
.method public isDoubleTapPowerWalletHasNoActiveCard()Z
    ...
    iget v0, p0, Lcom/android/server/policy/oxb;->dF:I

    const/4 v1, 0x1

    if-ne v0, v1, :cond_0

    invoke-direct {p0}, Lcom/android/server/policy/oxb;->ao()Z
...
.method public onKeyguardDone()V
    ...
    iget-boolean v0, p0, Lcom/android/server/policy/oxb;->ZE:Z
...
.method public processEmergencyTap(Landroid/view/KeyEvent;ZZ)Z
    ...
    iput-boolean v2, p0, Lcom/android/server/policy/oxb;->_E:Z
    ...
    iget p3, p0, Lcom/android/server/policy/oxb;->bF:I
    ...
    iput v5, p0, Lcom/android/server/policy/oxb;->bF:I

    goto :goto_0

    :cond_2
    iput v2, p0, Lcom/android/server/policy/oxb;->bF:I
    ...
    iget v0, p0, Lcom/android/server/policy/oxb;->bF:I
    ...
    iput v2, p0, Lcom/android/server/policy/oxb;->cF:I
    ...
    iput v9, p0, Lcom/android/server/policy/oxb;->cF:I
    ...
    iput v5, p0, Lcom/android/server/policy/oxb;->cF:I
    ...
    iget p1, p0, Lcom/android/server/policy/oxb;->bF:I
...
.method public updateSettings(Landroid/content/ContentResolver;)V
    ...
    :goto_0
    iput-boolean v1, p0, Lcom/android/server/policy/oxb;->VE:Z

    invoke-direct {p0, p1}, Lcom/android/server/policy/oxb;->you(Landroid/content/ContentResolver;)I

    move-result v1

    iput v1, p0, Lcom/android/server/policy/oxb;->bF:I
    ...
    iput p1, p0, Lcom/android/server/policy/oxb;->dF:I
