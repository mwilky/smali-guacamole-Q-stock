...
.field static final dS:I = 0x1eab92


# instance fields
.field SR:Landroid/view/SurfaceControl;
...
.field private final cS:Landroid/view/animation/Interpolator;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/wm/oif;->TOUCH_RESPONSE_INTERPOLATOR:Landroid/view/animation/Interpolator;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/DisplayContent;ZZLcom/android/server/wm/WindowManagerService;I)V
    ...
    iput-object v5, v1, Lcom/android/server/wm/oif;->mPerf:Landroid/util/BoostFramework;

    const/4 v6, 0x0

    iput-boolean v6, v1, Lcom/android/server/wm/oif;->mIsPerfLockAcquired:Z

    new-instance v7, Landroid/graphics/Rect;

    invoke-direct {v7}, Landroid/graphics/Rect;-><init>()V

    iput-object v7, v1, Lcom/android/server/wm/oif;->mOriginalDisplayRect:Landroid/graphics/Rect;

    new-instance v7, Landroid/graphics/Rect;

    invoke-direct {v7}, Landroid/graphics/Rect;-><init>()V

    iput-object v7, v1, Lcom/android/server/wm/oif;->mCurrentDisplayRect:Landroid/graphics/Rect;

    new-instance v7, Landroid/view/animation/Transformation;

    invoke-direct {v7}, Landroid/view/animation/Transformation;-><init>()V

    iput-object v7, v1, Lcom/android/server/wm/oif;->mRotateExitTransformation:Landroid/view/animation/Transformation;

    new-instance v7, Landroid/view/animation/Transformation;

    invoke-direct {v7}, Landroid/view/animation/Transformation;-><init>()V

    iput-object v7, v1, Lcom/android/server/wm/oif;->mRotateEnterTransformation:Landroid/view/animation/Transformation;

    new-instance v7, Landroid/view/animation/Transformation;

    invoke-direct {v7}, Landroid/view/animation/Transformation;-><init>()V

    iput-object v7, v1, Lcom/android/server/wm/oif;->mExitTransformation:Landroid/view/animation/Transformation;

    new-instance v7, Landroid/view/animation/Transformation;

    invoke-direct {v7}, Landroid/view/animation/Transformation;-><init>()V

    iput-object v7, v1, Lcom/android/server/wm/oif;->mEnterTransformation:Landroid/view/animation/Transformation;

    new-instance v7, Landroid/graphics/Matrix;

    invoke-direct {v7}, Landroid/graphics/Matrix;-><init>()V

    iput-object v7, v1, Lcom/android/server/wm/oif;->mSnapshotInitialMatrix:Landroid/graphics/Matrix;

    new-instance v7, Landroid/graphics/Matrix;

    invoke-direct {v7}, Landroid/graphics/Matrix;-><init>()V

    iput-object v7, v1, Lcom/android/server/wm/oif;->mSnapshotFinalMatrix:Landroid/graphics/Matrix;

    const/16 v7, 0x9

    new-array v7, v7, [F

    iput-object v7, v1, Lcom/android/server/wm/oif;->mTmpFloats:[F

    const/4 v7, 0x1

    iput-boolean v7, v1, Lcom/android/server/wm/oif;->TR:Z

    iput-boolean v6, v1, Lcom/android/server/wm/oif;->UR:Z

    iput-boolean v6, v1, Lcom/android/server/wm/oif;->WR:Z

    iput-boolean v6, v1, Lcom/android/server/wm/oif;->XR:Z

    iput-boolean v6, v1, Lcom/android/server/wm/oif;->YR:Z

    iput-boolean v6, v1, Lcom/android/server/wm/oif;->ZR:Z

    iput-boolean v6, v1, Lcom/android/server/wm/oif;->_R:Z

    invoke-static {}, Lcom/android/server/policy/OpPhoneWindowManagerInjector;->isGestureButtonEnabled()Z

    move-result v8

    iput-boolean v8, v1, Lcom/android/server/wm/oif;->aS:Z

    iput-boolean v7, v1, Lcom/android/server/wm/oif;->mHasSetRotation:Z
    ...
    iput-object v8, v1, Lcom/android/server/wm/oif;->cS:Landroid/view/animation/Interpolator;

    move-object/from16 v8, p5

    iput-object v8, v1, Lcom/android/server/wm/oif;->mService:Lcom/android/server/wm/WindowManagerService;

    iput-object v0, v1, Lcom/android/server/wm/oif;->mContext:Landroid/content/Context;

    iput-object v2, v1, Lcom/android/server/wm/oif;->mDisplayContent:Lcom/android/server/wm/DisplayContent;

    iget-object v8, v1, Lcom/android/server/wm/oif;->mOriginalDisplayRect:Landroid/graphics/Rect;

    invoke-virtual {v2, v8}, Lcom/android/server/wm/DisplayContent;->getBounds(Landroid/graphics/Rect;)V

    iput v4, v1, Lcom/android/server/wm/oif;->bS:I
    ...
    iput-object v0, v1, Lcom/android/server/wm/oif;->mLinearOutSlowInInterpolator:Landroid/view/animation/Interpolator;

    new-instance v0, Landroid/view/animation/LinearInterpolator;

    invoke-direct {v0}, Landroid/view/animation/LinearInterpolator;-><init>()V

    iput-object v0, v1, Lcom/android/server/wm/oif;->mLinearInterpolator:Landroid/view/animation/Interpolator;
    ...
    iput-object v10, v1, Lcom/android/server/wm/oif;->mDisplayInfo:Landroid/view/DisplayInfo;
    ...
    :pswitch_1
    iput-boolean v7, v1, Lcom/android/server/wm/oif;->XR:Z

    goto :goto_0

    :pswitch_2
    iput-boolean v6, v1, Lcom/android/server/wm/oif;->TR:Z
    ...
    :goto_0
    iget-boolean v11, v1, Lcom/android/server/wm/oif;->XR:Z
    ...
    iput-boolean v7, v1, Lcom/android/server/wm/oif;->WR:Z
    ...
    iput-boolean v7, v1, Lcom/android/server/wm/oif;->UR:Z
    ...
    iput-boolean v7, v1, Lcom/android/server/wm/oif;->_R:Z
    ...
    iput-boolean v7, v1, Lcom/android/server/wm/oif;->YR:Z
    ...
    iput-boolean v7, v1, Lcom/android/server/wm/oif;->ZR:Z
    ...
    invoke-static {}, Lcom/android/server/wm/qbh;->ke()Lcom/android/server/wm/AppWindowToken;
    ...
    invoke-static {}, Lcom/android/server/wm/qbh;->le()Lcom/android/server/wm/AppWindowToken;
    ...
    iget-boolean v5, v1, Lcom/android/server/wm/oif;->UR:Z
    ...
    iget-boolean v5, v1, Lcom/android/server/wm/oif;->WR:Z
    ...
    iget-boolean v5, v1, Lcom/android/server/wm/oif;->_R:Z
    ...
    iget-boolean v5, v1, Lcom/android/server/wm/oif;->TR:Z
    ...
    iget-boolean v5, v1, Lcom/android/server/wm/oif;->XR:Z
    ...
    iget-boolean v5, v1, Lcom/android/server/wm/oif;->YR:Z
    ...
    iget-boolean v5, v1, Lcom/android/server/wm/oif;->ZR:Z
    ...
    iput-object v4, v1, Lcom/android/server/wm/oif;->mPerf:Landroid/util/BoostFramework;

    if-eqz p3, :cond_c

    iput-boolean v7, v1, Lcom/android/server/wm/oif;->mForceDefaultOrientation:Z
    ...
    :cond_d
    iput v4, v1, Lcom/android/server/wm/oif;->mWidth:I

    iput v5, v1, Lcom/android/server/wm/oif;->mHeight:I

    goto :goto_9

    :cond_e
    :goto_8
    iput v5, v1, Lcom/android/server/wm/oif;->mWidth:I

    iput v4, v1, Lcom/android/server/wm/oif;->mHeight:I

    :goto_9
    iput v8, v1, Lcom/android/server/wm/oif;->mOriginalRotation:I

    iput v4, v1, Lcom/android/server/wm/oif;->mOriginalWidth:I

    iput v5, v1, Lcom/android/server/wm/oif;->mOriginalHeight:I

    iget-object v6, v1, Lcom/android/server/wm/oif;->mService:Lcom/android/server/wm/WindowManagerService;
    ...
    :try_start_0
    iget-boolean v10, v1, Lcom/android/server/wm/oif;->UR:Z
    :try_end_0
    ...
    :try_start_1
    iget-boolean v10, v1, Lcom/android/server/wm/oif;->XR:Z
    ...
    iget v11, v1, Lcom/android/server/wm/oif;->mWidth:I

    iget v13, v1, Lcom/android/server/wm/oif;->mHeight:I
    ...
    :goto_a
    iput-object v10, v1, Lcom/android/server/wm/oif;->mSurfaceControl:Landroid/view/SurfaceControl;
    ...
    iget v10, v1, Lcom/android/server/wm/oif;->mWidth:I

    iget v11, v1, Lcom/android/server/wm/oif;->mHeight:I
    ...
    iput-object v2, v1, Lcom/android/server/wm/oif;->SR:Landroid/view/SurfaceControl;

    iget-object v2, v1, Lcom/android/server/wm/oif;->mService:Lcom/android/server/wm/WindowManagerService;
    ...
    iget-object v3, v1, Lcom/android/server/wm/oif;->mSurfaceControl:Landroid/view/SurfaceControl;
    ...
    iget v10, v1, Lcom/android/server/wm/oif;->mHeight:I
    ...
    iget-object v3, v1, Lcom/android/server/wm/oif;->mService:Lcom/android/server/wm/WindowManagerService;
    ...
    iget v4, v1, Lcom/android/server/wm/oif;->mWidth:I

    iget v5, v1, Lcom/android/server/wm/oif;->mHeight:I
    ...
    iget-object v0, v1, Lcom/android/server/wm/oif;->mSurfaceControl:Landroid/view/SurfaceControl;
    ...
    :goto_d
    iget-object v0, v1, Lcom/android/server/wm/oif;->SR:Landroid/view/SurfaceControl;
    ...
    iget-object v2, v1, Lcom/android/server/wm/oif;->mSurfaceControl:Landroid/view/SurfaceControl;
    ...
    :cond_14
    invoke-direct {v1, v6, v8}, Lcom/android/server/wm/oif;->setRotation(Landroid/view/SurfaceControl$Transaction;I)V
...
.method private hasAnimations()Z
    ...
    iget-object v0, p0, Lcom/android/server/wm/oif;->mRotateEnterAnimation:Landroid/view/animation/Animation;

    if-nez v0, :cond_1

    iget-object p0, p0, Lcom/android/server/wm/oif;->mRotateExitAnimation:Landroid/view/animation/Animation;
...
.method private setRotation(Landroid/view/SurfaceControl$Transaction;I)V
    ...
    iput p2, p0, Lcom/android/server/wm/oif;->mCurRotation:I
    ...
    iget v0, p0, Lcom/android/server/wm/oif;->mWidth:I

    iget v1, p0, Lcom/android/server/wm/oif;->mHeight:I

    iget-object v2, p0, Lcom/android/server/wm/oif;->mSnapshotInitialMatrix:Landroid/graphics/Matrix;

    invoke-static {p2, v0, v1, v2}, Lcom/android/server/wm/oif;->createRotationMatrix(IIILandroid/graphics/Matrix;)V

    iget-object p2, p0, Lcom/android/server/wm/oif;->mSnapshotInitialMatrix:Landroid/graphics/Matrix;

    const/high16 v0, 0x3f800000    # 1.0f

    const/4 v1, 0x0

    invoke-direct {p0, p1, p2, v0, v1}, Lcom/android/server/wm/oif;->zta(Landroid/view/SurfaceControl$Transaction;Landroid/graphics/Matrix;FLandroid/graphics/Rect;)V

    iget-object p2, p0, Lcom/android/server/wm/oif;->mSnapshotInitialMatrix:Landroid/graphics/Matrix;

    invoke-direct {p0, p1, p2, v0}, Lcom/android/server/wm/oif;->zta(Landroid/view/SurfaceControl$Transaction;Landroid/graphics/Matrix;F)V
...
.method private startAnimation(Landroid/view/SurfaceControl$Transaction;JFIIZII)Z
    ...
    iget-object v6, v0, Lcom/android/server/wm/oif;->mSurfaceControl:Landroid/view/SurfaceControl;

    if-eqz v6, :cond_1e

    iget-object v6, v0, Lcom/android/server/wm/oif;->SR:Landroid/view/SurfaceControl;
    ...
    :cond_0
    iget-boolean v6, v0, Lcom/android/server/wm/oif;->mStarted:Z
    ...
    :cond_1
    iput-boolean v12, v0, Lcom/android/server/wm/oif;->mStarted:Z

    iget v6, v0, Lcom/android/server/wm/oif;->mCurRotation:I

    iget v7, v0, Lcom/android/server/wm/oif;->mOriginalRotation:I
    ...
    iget v7, v0, Lcom/android/server/wm/oif;->mOriginalWidth:I
    ...
    iget v7, v0, Lcom/android/server/wm/oif;->mOriginalHeight:I
    ...
    iget-object v7, v0, Lcom/android/server/wm/oif;->mContext:Landroid/content/Context;
    ...
    iput-object v4, v0, Lcom/android/server/wm/oif;->mRotateExitAnimation:Landroid/view/animation/Animation;

    iget-object v4, v0, Lcom/android/server/wm/oif;->mContext:Landroid/content/Context;

    invoke-static {v4, v5}, Landroid/view/animation/AnimationUtils;->loadAnimation(Landroid/content/Context;I)Landroid/view/animation/Animation;

    move-result-object v4

    iput-object v4, v0, Lcom/android/server/wm/oif;->mRotateEnterAnimation:Landroid/view/animation/Animation;
    ...
    :cond_4
    iget-boolean v12, v0, Lcom/android/server/wm/oif;->XR:Z
    ...
    :cond_5
    iget-boolean v12, v0, Lcom/android/server/wm/oif;->ZR:Z
    ...
    :cond_6
    iget-boolean v4, v0, Lcom/android/server/wm/oif;->YR:Z
    ...
    :cond_7
    iget-boolean v4, v0, Lcom/android/server/wm/oif;->UR:Z
    ...
    :cond_8
    iget-boolean v4, v0, Lcom/android/server/wm/oif;->WR:Z

    if-eqz v4, :cond_b

    iget-boolean v4, v0, Lcom/android/server/wm/oif;->aS:Z

    if-eqz v4, :cond_a

    iget-boolean v4, v0, Lcom/android/server/wm/oif;->_R:Z
    ...
    :cond_b
    iget-boolean v4, v0, Lcom/android/server/wm/oif;->TR:Z
    ...
    :goto_0
    iget-object v5, v0, Lcom/android/server/wm/oif;->mContext:Landroid/content/Context;
    ...
    :cond_17
    iget-object v4, v0, Lcom/android/server/wm/oif;->mRotateEnterAnimation:Landroid/view/animation/Animation;

    iget v7, v0, Lcom/android/server/wm/oif;->mOriginalWidth:I

    iget v8, v0, Lcom/android/server/wm/oif;->mOriginalHeight:I
    ...
    iget-object v4, v0, Lcom/android/server/wm/oif;->mRotateExitAnimation:Landroid/view/animation/Animation;
    ...
    iget-object v5, v0, Lcom/android/server/wm/oif;->mDisplayContent:Lcom/android/server/wm/DisplayContent;
    ...
    iget-object v4, v0, Lcom/android/server/wm/oif;->mDisplayContent:Lcom/android/server/wm/DisplayContent;
    ...
    iget-object v6, v0, Lcom/android/server/wm/oif;->mDisplayContent:Lcom/android/server/wm/DisplayContent;
    ...
    invoke-direct {v0, v4, v11}, Lcom/android/server/wm/oif;->zta(Landroid/graphics/Rect;I)Landroid/graphics/Point;

    move-result-object v5

    iget-boolean v6, v0, Lcom/android/server/wm/oif;->UR:Z
    ...
    iget-object v9, v0, Lcom/android/server/wm/oif;->mDisplayInfo:Landroid/view/DisplayInfo;
    ...
    invoke-direct {v0, v6, v8, v4, v5}, Lcom/android/server/wm/oif;->zta(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Point;)Landroid/view/animation/Animation;
    ...
    :goto_8
    iget-object v5, v0, Lcom/android/server/wm/oif;->mRotateEnterAnimation:Landroid/view/animation/Animation;
    ...
    iget v5, v0, Lcom/android/server/wm/oif;->mOriginalWidth:I

    iget v6, v0, Lcom/android/server/wm/oif;->mOriginalHeight:I
    ...
    iput-boolean v4, v0, Lcom/android/server/wm/oif;->mAnimRunning:Z

    iput-boolean v4, v0, Lcom/android/server/wm/oif;->mFinishAnimReady:Z

    const-wide/16 v4, -0x1

    iput-wide v4, v0, Lcom/android/server/wm/oif;->mFinishAnimStartTime:J
    ...
    iget-object v0, v0, Lcom/android/server/wm/oif;->mRotateEnterAnimation:Landroid/view/animation/Animation;
...
.method private stepAnimation(J)Z
    ...
    iget-wide v0, p0, Lcom/android/server/wm/oif;->mHalfwayPoint:J
    ...
    iput-wide v0, p0, Lcom/android/server/wm/oif;->mHalfwayPoint:J

    :cond_0
    iget-boolean v0, p0, Lcom/android/server/wm/oif;->mFinishAnimReady:Z

    if-eqz v0, :cond_1

    iget-wide v0, p0, Lcom/android/server/wm/oif;->mFinishAnimStartTime:J
    ...
    iput-wide p1, p0, Lcom/android/server/wm/oif;->mFinishAnimStartTime:J
    ...
    iput-boolean v0, p0, Lcom/android/server/wm/oif;->mMoreRotateExit:Z

    iget-object v1, p0, Lcom/android/server/wm/oif;->mRotateExitAnimation:Landroid/view/animation/Animation;

    if-eqz v1, :cond_2

    iget-object v2, p0, Lcom/android/server/wm/oif;->mRotateExitTransformation:Landroid/view/animation/Transformation;

    invoke-virtual {v1, p1, p2, v2}, Landroid/view/animation/Animation;->getTransformation(JLandroid/view/animation/Transformation;)Z

    move-result v1

    iput-boolean v1, p0, Lcom/android/server/wm/oif;->mMoreRotateExit:Z

    :cond_2
    iput-boolean v0, p0, Lcom/android/server/wm/oif;->mMoreRotateEnter:Z

    iget-object v1, p0, Lcom/android/server/wm/oif;->mRotateEnterAnimation:Landroid/view/animation/Animation;

    if-eqz v1, :cond_3

    iget-object v2, p0, Lcom/android/server/wm/oif;->mRotateEnterTransformation:Landroid/view/animation/Transformation;

    invoke-virtual {v1, p1, p2, v2}, Landroid/view/animation/Animation;->getTransformation(JLandroid/view/animation/Transformation;)Z

    move-result p1

    iput-boolean p1, p0, Lcom/android/server/wm/oif;->mMoreRotateEnter:Z

    :cond_3
    iget-object p1, p0, Lcom/android/server/wm/oif;->mExitTransformation:Landroid/view/animation/Transformation;

    iget-object p2, p0, Lcom/android/server/wm/oif;->mRotateExitTransformation:Landroid/view/animation/Transformation;

    invoke-virtual {p1, p2}, Landroid/view/animation/Transformation;->set(Landroid/view/animation/Transformation;)V

    iget-object p1, p0, Lcom/android/server/wm/oif;->mEnterTransformation:Landroid/view/animation/Transformation;

    iget-object p2, p0, Lcom/android/server/wm/oif;->mRotateEnterTransformation:Landroid/view/animation/Transformation;

    invoke-virtual {p1, p2}, Landroid/view/animation/Transformation;->set(Landroid/view/animation/Transformation;)V

    iget-boolean p1, p0, Lcom/android/server/wm/oif;->mMoreRotateEnter:Z

    if-nez p1, :cond_4

    iget-boolean p1, p0, Lcom/android/server/wm/oif;->mMoreRotateExit:Z

    if-nez p1, :cond_4

    iget-boolean p1, p0, Lcom/android/server/wm/oif;->mFinishAnimReady:Z
    ...
    :cond_5
    iget-object p1, p0, Lcom/android/server/wm/oif;->mSnapshotFinalMatrix:Landroid/graphics/Matrix;

    iget-object p2, p0, Lcom/android/server/wm/oif;->mExitTransformation:Landroid/view/animation/Transformation;

    invoke-virtual {p2}, Landroid/view/animation/Transformation;->getMatrix()Landroid/graphics/Matrix;

    move-result-object p2

    iget-object p0, p0, Lcom/android/server/wm/oif;->mSnapshotInitialMatrix:Landroid/graphics/Matrix;
...
.method private zta(Landroid/graphics/Rect;I)Landroid/graphics/Point;
    ...
    iget p2, p0, Lcom/android/server/wm/oif;->mOriginalHeight:I
    ...
    iget p0, p0, Lcom/android/server/wm/oif;->mOriginalWidth:I
    ...
    iget v1, p0, Lcom/android/server/wm/oif;->mOriginalHeight:I
...
.method private zta(IZLandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Point;)Landroid/view/animation/Animation;
    ...
    iget-object v6, v0, Lcom/android/server/wm/oif;->mLinearOutSlowInInterpolator:Landroid/view/animation/Interpolator;
    ...
    sget-object v1, Lcom/android/server/wm/oif;->TOUCH_RESPONSE_INTERPOLATOR:Landroid/view/animation/Interpolator;
    ...
    iget-object v4, v0, Lcom/android/server/wm/oif;->mLinearOutSlowInInterpolator:Landroid/view/animation/Interpolator;
    ...
    iget-object v2, v0, Lcom/android/server/wm/oif;->cS:Landroid/view/animation/Interpolator;
    ...
    iget-object v0, v0, Lcom/android/server/wm/oif;->mLinearOutSlowInInterpolator:Landroid/view/animation/Interpolator;
...
.method private zta(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Point;)Landroid/view/animation/Animation;
    ...
    iget-object p3, p0, Lcom/android/server/wm/oif;->mService:Lcom/android/server/wm/WindowManagerService;
    ...
    iget-object p1, p0, Lcom/android/server/wm/oif;->mLinearInterpolator:Landroid/view/animation/Interpolator;
    ...
    iget-object p0, p0, Lcom/android/server/wm/oif;->mService:Lcom/android/server/wm/WindowManagerService;
...
.method private zta(Landroid/view/SurfaceControl$Transaction;Landroid/graphics/Matrix;F)V
    ...
    iget-object v0, p0, Lcom/android/server/wm/oif;->SR:Landroid/view/SurfaceControl;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/android/server/wm/oif;->mTmpFloats:[F

    invoke-virtual {p2, v0}, Landroid/graphics/Matrix;->getValues([F)V

    iget-object p2, p0, Lcom/android/server/wm/oif;->mTmpFloats:[F
    ...
    iget-boolean v1, p0, Lcom/android/server/wm/oif;->mForceDefaultOrientation:Z

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/android/server/wm/oif;->mDisplayContent:Lcom/android/server/wm/DisplayContent;

    iget-object v2, p0, Lcom/android/server/wm/oif;->mCurrentDisplayRect:Landroid/graphics/Rect;

    invoke-virtual {v1, v2}, Lcom/android/server/wm/DisplayContent;->getBounds(Landroid/graphics/Rect;)V

    iget-object v1, p0, Lcom/android/server/wm/oif;->mCurrentDisplayRect:Landroid/graphics/Rect;
    ...
    :cond_0
    iget-object v1, p0, Lcom/android/server/wm/oif;->SR:Landroid/view/SurfaceControl;
    ...
    iget-object v3, p0, Lcom/android/server/wm/oif;->SR:Landroid/view/SurfaceControl;
    ...
    iget-object p0, p0, Lcom/android/server/wm/oif;->SR:Landroid/view/SurfaceControl;
...
.method private zta(Landroid/view/SurfaceControl$Transaction;Landroid/graphics/Matrix;FLandroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Lcom/android/server/wm/oif;->mSurfaceControl:Landroid/view/SurfaceControl;
    ...
    :cond_0
    iget-object v1, p0, Lcom/android/server/wm/oif;->mSurfaceControl:Landroid/view/SurfaceControl;

    invoke-virtual {p1, v1, v0, p2}, Landroid/view/SurfaceControl$Transaction;->setPosition(Landroid/view/SurfaceControl;FF)Landroid/view/SurfaceControl$Transaction;

    iget-object v3, p0, Lcom/android/server/wm/oif;->mSurfaceControl:Landroid/view/SurfaceControl;
    ...
    iget-object p2, p0, Lcom/android/server/wm/oif;->mSurfaceControl:Landroid/view/SurfaceControl;
    ...
    iget-object p0, p0, Lcom/android/server/wm/oif;->mSurfaceControl:Landroid/view/SurfaceControl;
...
.method public dismiss(Landroid/view/SurfaceControl$Transaction;JFIIII)Z
    ...
    :cond_0
    iget-object v0, v10, Lcom/android/server/wm/oif;->mSurfaceControl:Landroid/view/SurfaceControl;

    const/4 v12, 0x0

    if-eqz v0, :cond_5

    iget-object v0, v10, Lcom/android/server/wm/oif;->SR:Landroid/view/SurfaceControl;
    ...
    :cond_1
    iget-boolean v0, v10, Lcom/android/server/wm/oif;->mStarted:Z
    ...
    invoke-direct/range {v0 .. v9}, Lcom/android/server/wm/oif;->startAnimation(Landroid/view/SurfaceControl$Transaction;JFIIZII)Z
    ...
    iput-boolean v0, v10, Lcom/android/server/wm/oif;->mFinishAnimReady:Z
...
.method public getEnterTransformation()Landroid/view/animation/Transformation;
    ...
    iget-object p0, p0, Lcom/android/server/wm/oif;->mEnterTransformation:Landroid/view/animation/Transformation;
...
.method public hasSetRotation()Z
    ...
    iget-boolean p0, p0, Lcom/android/server/wm/oif;->mHasSetRotation:Z
...
.method public isAnimating()Z
    ...
    invoke-direct {p0}, Lcom/android/server/wm/oif;->hasAnimations()Z

    move-result v0

    if-nez v0, :cond_1

    iget-boolean p0, p0, Lcom/android/server/wm/oif;->mFinishAnimReady:Z
...
.method public isRotating()Z
    ...
    iget v0, p0, Lcom/android/server/wm/oif;->mCurRotation:I

    iget p0, p0, Lcom/android/server/wm/oif;->mOriginalRotation:I
...
.method public kill()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/wm/oif;->mDisplayContent:Lcom/android/server/wm/DisplayContent;
    ...
    iget-object v0, p0, Lcom/android/server/wm/oif;->mEnterTransformation:Landroid/view/animation/Transformation;
    ...
    iput-object v1, p0, Lcom/android/server/wm/oif;->mEnterTransformation:Landroid/view/animation/Transformation;
    ...
    iget-object v5, p0, Lcom/android/server/wm/oif;->mSurfaceControl:Landroid/view/SurfaceControl;
    ...
    iput-object v1, p0, Lcom/android/server/wm/oif;->mSurfaceControl:Landroid/view/SurfaceControl;
    ...
    iput-object v1, p0, Lcom/android/server/wm/oif;->SR:Landroid/view/SurfaceControl;

    :cond_7
    iget-object v0, p0, Lcom/android/server/wm/oif;->mRotateExitAnimation:Landroid/view/animation/Animation;

    if-eqz v0, :cond_8

    invoke-virtual {v0}, Landroid/view/animation/Animation;->cancel()V

    iput-object v1, p0, Lcom/android/server/wm/oif;->mRotateExitAnimation:Landroid/view/animation/Animation;
    ...
    iput-object v1, p0, Lcom/android/server/wm/oif;->mRotateEnterAnimation:Landroid/view/animation/Animation;

    :cond_9
    iget-object v0, p0, Lcom/android/server/wm/oif;->mPerf:Landroid/util/BoostFramework;

    if-eqz v0, :cond_a

    iget-boolean v1, p0, Lcom/android/server/wm/oif;->mIsPerfLockAcquired:Z
    ...
    iput-boolean v0, p0, Lcom/android/server/wm/oif;->mIsPerfLockAcquired:Z
...
.method public printTo(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    iget v0, p0, Lcom/android/server/wm/oif;->mHeight:I
    ...
    iget v0, p0, Lcom/android/server/wm/oif;->mOriginalRotation:I
    ...
    iget v0, p0, Lcom/android/server/wm/oif;->mOriginalWidth:I
    ...
    iget v0, p0, Lcom/android/server/wm/oif;->mOriginalHeight:I
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/oif;->mStarted:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/oif;->mAnimRunning:Z
    ...
    iget-object v1, p0, Lcom/android/server/wm/oif;->mRotateExitTransformation:Landroid/view/animation/Transformation;
    ...
    iget-object v0, p0, Lcom/android/server/wm/oif;->mRotateEnterTransformation:Landroid/view/animation/Transformation;
    ...
    iget-object v0, p0, Lcom/android/server/wm/oif;->mExitTransformation:Landroid/view/animation/Transformation;
    ...
    iget-object v0, p0, Lcom/android/server/wm/oif;->mSnapshotInitialMatrix:Landroid/graphics/Matrix;
    ...
    iget-object v0, p0, Lcom/android/server/wm/oif;->mSnapshotFinalMatrix:Landroid/graphics/Matrix;
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/oif;->mForceDefaultOrientation:Z
    ...
    iget-object v0, p0, Lcom/android/server/wm/oif;->mOriginalDisplayRect:Landroid/graphics/Rect;
    ...
    iget-object v0, p0, Lcom/android/server/wm/oif;->mCurrentDisplayRect:Landroid/graphics/Rect;
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/oif;->TR:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/oif;->UR:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/oif;->WR:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/oif;->_R:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/oif;->XR:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/oif;->YR:Z
    ...
    iget-boolean p0, p0, Lcom/android/server/wm/oif;->ZR:Z
...
.method public setRotation(Landroid/view/SurfaceControl$Transaction;IJFII)Z
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/wm/oif;->setRotation(Landroid/view/SurfaceControl$Transaction;I)V
...
.method public stepAnimationLocked(J)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/wm/oif;->mFinishAnimReady:Z
    ...
    iput-boolean v0, p0, Lcom/android/server/wm/oif;->mAnimRunning:Z
    ...
    iput-wide v1, p0, Lcom/android/server/wm/oif;->mHalfwayPoint:J

    iget-object v1, p0, Lcom/android/server/wm/oif;->mPerf:Landroid/util/BoostFramework;

    if-eqz v1, :cond_3

    iget-boolean v2, p0, Lcom/android/server/wm/oif;->mIsPerfLockAcquired:Z
    ...
    :cond_3
    invoke-direct {p0, p1, p2}, Lcom/android/server/wm/oif;->stepAnimation(J)Z
...
.method public updateSurfaces(Landroid/view/SurfaceControl$Transaction;)V
    ...
    iget-boolean v1, p0, Lcom/android/server/wm/oif;->mMoreRotateExit:Z
    ...
    iget-object v1, p0, Lcom/android/server/wm/oif;->mExitTransformation:Landroid/view/animation/Transformation;

    invoke-virtual {v1}, Landroid/view/animation/Transformation;->getAlpha()F

    move-result v1

    iget-object v2, p0, Lcom/android/server/wm/oif;->mExitTransformation:Landroid/view/animation/Transformation;

    invoke-virtual {v2}, Landroid/view/animation/Transformation;->getClipRect()Landroid/graphics/Rect;

    move-result-object v2

    invoke-direct {p0, p1, v0, v1, v2}, Lcom/android/server/wm/oif;->zta(Landroid/view/SurfaceControl$Transaction;Landroid/graphics/Matrix;FLandroid/graphics/Rect;)V

    iget-object v0, p0, Lcom/android/server/wm/oif;->mSnapshotFinalMatrix:Landroid/graphics/Matrix;

    const/4 v1, 0x0

    invoke-direct {p0, p1, v0, v1}, Lcom/android/server/wm/oif;->zta(Landroid/view/SurfaceControl$Transaction;Landroid/graphics/Matrix;F)V
...
.method public writeToProto(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    iget-boolean p0, p0, Lcom/android/server/wm/oif;->mAnimRunning:Z
