.class public Lcom/android/server/wm/cgv;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/wm/cgv$sis;,
        Lcom/android/server/wm/cgv$you;,
        Lcom/android/server/wm/cgv$zta;
    }
.end annotation
...
.field public static final DW:I = 0x28

.field public static final EW:I = 0x28

.field public static final FW:I = 0x28

.field public static GW:I = 0x0

.field public static HW:I = 0x0

.field public static IW:I = 0x0

.field public static final JW:I = 0x12c

.field public static final KW:I = 0x64

.field public static LW:I = 0x0

.field public static MW:I = 0x0

.field private static final NW:Ljava/util/List;
...
.field private static final OW:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field public static PW:Ljava/util/List; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field public static QW:Ljava/util/List; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field private static gW:Ljava/lang/Object; = null

.field private static final hW:Ljava/lang/String; = "Quick_Reply_Config"

.field private static final iW:Ljava/lang/String; = "com.oneplus.action.QUICK_REPLY_SETTINGS"

.field private static final jW:Ljava/lang/String; = "com.android.settings"

.field public static final kW:F = 0.4f

.field public static lW:I = 0x0

.field public static final mW:I = 0x0

.field public static final nW:I = 0x1

.field public static final oW:I = 0x2

.field public static final pW:I = 0x30a

.field public static final qW:I = 0x60

.field public static final rW:I = 0x54

.field public static sIMELimitWidth:I = 0x0

.field private static sInstance:Lcom/android/server/wm/cgv; = null

.field public static final sW:I = 0x2a

.field public static final tW:I = 0x3c

.field public static final uW:I = 0x30

.field public static vW:I

.field public static wW:I
...
.field private FV:Lcom/android/server/wm/WindowManagerService;

.field private GV:Landroid/view/WindowManager$LayoutParams;

.field private HV:Landroid/view/WindowManager$LayoutParams;

.field private IV:Landroid/view/WindowManager$LayoutParams;

.field private KV:Landroid/view/WindowManager$LayoutParams;

.field private MV:Lcom/android/server/wm/cgv$zta;

.field private OV:Lcom/android/server/wm/ActivityRecord;
...
.field private RV:Lcom/android/internal/view/IInputMethodManager;
...
.field private final YV:Landroid/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field cW:Landroid/view/View;

.field dW:Landroid/view/View;

.field eW:Landroid/widget/FrameLayout;

.field fW:Landroid/widget/FrameLayout;
...
.field private mSettingsObserver:Lcom/android/server/wm/cgv$sis;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/wm/cgv;->gW:Ljava/lang/Object;
    ...
    sput v0, Lcom/android/server/wm/cgv;->vW:I

    const/16 v0, 0x60

    sput v0, Lcom/android/server/wm/cgv;->wW:I

    const/16 v0, 0x54

    sput v0, Lcom/android/server/wm/cgv;->xW:I

    const/16 v0, 0x2a

    sput v0, Lcom/android/server/wm/cgv;->yW:I

    const/16 v0, 0x3c

    sput v0, Lcom/android/server/wm/cgv;->zW:I

    const/16 v0, 0x30

    sput v0, Lcom/android/server/wm/cgv;->AW:I

    const/16 v0, 0x438

    sput v0, Lcom/android/server/wm/cgv;->sIMELimitWidth:I

    const/16 v0, 0x28

    sput v0, Lcom/android/server/wm/cgv;->GW:I

    sput v0, Lcom/android/server/wm/cgv;->HW:I

    sput v0, Lcom/android/server/wm/cgv;->IW:I
    ...
    sput v0, Lcom/android/server/wm/cgv;->MW:I
    ...
    sput-object v0, Lcom/android/server/wm/cgv;->NW:Ljava/util/List;
    ...
    sput-object v0, Lcom/android/server/wm/cgv;->OW:Ljava/util/List;
    ...
    sput-object v0, Lcom/android/server/wm/cgv;->PW:Ljava/util/List;
    ...
    sput-object v0, Lcom/android/server/wm/cgv;->QW:Ljava/util/List;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/wm/cgv;->DV:Z

    iput-boolean v0, p0, Lcom/android/server/wm/cgv;->EV:Z

    const/4 v0, -0x1

    iput v0, p0, Lcom/android/server/wm/cgv;->mScreenHeight:I

    iput v0, p0, Lcom/android/server/wm/cgv;->mScreenWidth:I

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/wm/cgv;->PV:Ljava/util/ArrayList;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/android/server/wm/cgv;->QV:Z

    new-instance v0, Landroid/util/ArrayMap;

    invoke-direct {v0}, Landroid/util/ArrayMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/wm/cgv;->YV:Landroid/util/ArrayMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/wm/cgv;->ZV:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/android/server/wm/cgv;->_V:Ljava/util/List;

    iput-object p1, p0, Lcom/android/server/wm/cgv;->mContext:Landroid/content/Context;
...
.method private Bq()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/server/wm/cgv;->FV:Lcom/android/server/wm/WindowManagerService;
...
.method private Cq()V
    ...
    :goto_1
    iget-object v3, p0, Lcom/android/server/wm/cgv;->FV:Lcom/android/server/wm/WindowManagerService;
    ...
    invoke-direct {p0, v5}, Lcom/android/server/wm/cgv;->yc(Ljava/lang/String;)Z
...
.method private Dq()V
    ...
    iget-object v5, p0, Lcom/android/server/wm/cgv;->YV:Landroid/util/ArrayMap;
...
.method private Eq()V
    ...
    invoke-direct {p0}, Lcom/android/server/wm/cgv;->getWindowManager()Landroid/view/WindowManager;

    move-result-object v0

    iget-object v2, p0, Lcom/android/server/wm/cgv;->aW:Landroid/view/View;

    invoke-interface {v0, v2}, Landroid/view/WindowManager;->removeView(Landroid/view/View;)V

    :cond_0
    iput-object v1, p0, Lcom/android/server/wm/cgv;->aW:Landroid/view/View;

    :cond_1
    iget-object v0, p0, Lcom/android/server/wm/cgv;->cW:Landroid/view/View;
    ...
    iget-object v2, p0, Lcom/android/server/wm/cgv;->cW:Landroid/view/View;

    invoke-interface {v0, v2}, Landroid/view/WindowManager;->removeView(Landroid/view/View;)V

    :cond_2
    iput-object v1, p0, Lcom/android/server/wm/cgv;->cW:Landroid/view/View;

    :cond_3
    iget-object v0, p0, Lcom/android/server/wm/cgv;->dW:Landroid/view/View;
    ...
    iget-object v2, p0, Lcom/android/server/wm/cgv;->dW:Landroid/view/View;

    invoke-interface {v0, v2}, Landroid/view/WindowManager;->removeView(Landroid/view/View;)V

    :cond_4
    iput-object v1, p0, Lcom/android/server/wm/cgv;->dW:Landroid/view/View;
...
.method private Fq()V
    ...
    iget-object v0, p0, Lcom/android/server/wm/cgv;->bW:Landroid/view/View;
    ...
    iget-object v1, p0, Lcom/android/server/wm/cgv;->bW:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/server/wm/cgv;->bW:Landroid/view/View;
...
.method private Gq()V
    ...
    iget-object p0, p0, Lcom/android/server/wm/cgv;->KV:Landroid/view/WindowManager$LayoutParams;
...
.method private Hq()V
    ...
    iget v3, p0, Lcom/android/server/wm/cgv;->mScreenHeight:I

    if-ne v1, v3, :cond_0

    iget v1, p0, Lcom/android/server/wm/cgv;->mScreenWidth:I
    ...
    iput v1, p0, Lcom/android/server/wm/cgv;->mScreenHeight:I
    ...
    iget v0, p0, Lcom/android/server/wm/cgv;->mScreenWidth:I
    ...
    sput v1, Lcom/android/server/wm/cgv;->vW:I
    ...
    sput v1, Lcom/android/server/wm/cgv;->wW:I
    ...
    sput v1, Lcom/android/server/wm/cgv;->xW:I
    ...
    sput v1, Lcom/android/server/wm/cgv;->yW:I
    ...
    sput v1, Lcom/android/server/wm/cgv;->zW:I
    ...
    sput v1, Lcom/android/server/wm/cgv;->AW:I
    ...
    sput v2, Lcom/android/server/wm/cgv;->GW:I

    invoke-static {v1}, Ljava/lang/Math;->round(F)I

    move-result v2

    sput v2, Lcom/android/server/wm/cgv;->HW:I

    invoke-static {v1}, Ljava/lang/Math;->round(F)I

    move-result v1

    sput v1, Lcom/android/server/wm/cgv;->IW:I
    ...
    iget v0, p0, Lcom/android/server/wm/cgv;->mScreenHeight:I
    ...
    sput v2, Lcom/android/server/wm/cgv;->IW:I
    ...
    :cond_1
    invoke-direct {p0, v2}, Lcom/android/server/wm/cgv;->Na(Z)V
    ...
    sput v1, Lcom/android/server/wm/cgv;->sIMELimitWidth:I
    ...
    sget v3, Lcom/android/server/wm/cgv;->sIMELimitWidth:I
    ...
    sget v1, Lcom/android/server/wm/cgv;->vW:I
    ...
    sget v1, Lcom/android/server/wm/cgv;->sIMELimitWidth:I
    ...
    iput-object v0, p0, Lcom/android/server/wm/cgv;->GV:Landroid/view/WindowManager$LayoutParams;

    iget-object v0, p0, Lcom/android/server/wm/cgv;->GV:Landroid/view/WindowManager$LayoutParams;

    const/16 v1, 0x33

    iput v1, v0, Landroid/view/WindowManager$LayoutParams;->gravity:I

    sget v1, Lcom/android/server/wm/cgv;->yW:I
    ...
    iput-object v0, p0, Lcom/android/server/wm/cgv;->HV:Landroid/view/WindowManager$LayoutParams;

    iget-object v0, p0, Lcom/android/server/wm/cgv;->HV:Landroid/view/WindowManager$LayoutParams;

    iget-object v1, p0, Lcom/android/server/wm/cgv;->GV:Landroid/view/WindowManager$LayoutParams;
    ...
    iput-object v0, p0, Lcom/android/server/wm/cgv;->IV:Landroid/view/WindowManager$LayoutParams;

    iget-object v0, p0, Lcom/android/server/wm/cgv;->IV:Landroid/view/WindowManager$LayoutParams;
    ...
    iput-object v0, p0, Lcom/android/server/wm/cgv;->KV:Landroid/view/WindowManager$LayoutParams;
...
.method private Iq()V
    ...
    sget v1, Lcom/android/server/wm/cgv;->lW:I

    const/4 v2, 0x2

    if-ne v1, v2, :cond_1

    iget-object v1, p0, Lcom/android/server/wm/cgv;->HV:Landroid/view/WindowManager$LayoutParams;

    sget v2, Lcom/android/server/wm/cgv;->zW:I
    ...
    sget v2, Lcom/android/server/wm/cgv;->wW:I

    add-int/2addr v1, v2

    sget v3, Lcom/android/server/wm/cgv;->AW:I

    add-int/2addr v1, v3

    iput v1, v0, Landroid/view/WindowManager$LayoutParams;->x:I

    iget-object v1, p0, Lcom/android/server/wm/cgv;->IV:Landroid/view/WindowManager$LayoutParams;
    ...
    sget v3, Lcom/android/server/wm/cgv;->wW:I
    ...
    sget v2, Lcom/android/server/wm/cgv;->AW:I
    ...
    iget v1, p0, Lcom/android/server/wm/cgv;->mScreenHeight:I
    ...
    sget v4, Lcom/android/server/wm/cgv;->AW:I
    ...
    iget-object v1, p0, Lcom/android/server/wm/cgv;->aW:Landroid/view/View;

    iget-object v2, p0, Lcom/android/server/wm/cgv;->GV:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v1, p0, Lcom/android/server/wm/cgv;->cW:Landroid/view/View;

    iget-object v2, p0, Lcom/android/server/wm/cgv;->HV:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v1, p0, Lcom/android/server/wm/cgv;->dW:Landroid/view/View;

    iget-object p0, p0, Lcom/android/server/wm/cgv;->IV:Landroid/view/WindowManager$LayoutParams;
...
.method private Jq()V
    ...
    iget-object v1, p0, Lcom/android/server/wm/cgv;->KV:Landroid/view/WindowManager$LayoutParams;

    iget v3, p0, Lcom/android/server/wm/cgv;->mScreenHeight:I

    iput v3, v1, Landroid/view/WindowManager$LayoutParams;->x:I

    iget-object v3, p0, Lcom/android/server/wm/cgv;->mDisplayFrames:Lcom/android/server/wm/DisplayFrames;
    ...
    :cond_1
    iget-object v1, p0, Lcom/android/server/wm/cgv;->mDisplayFrames:Lcom/android/server/wm/DisplayFrames;

    iget-object v1, v1, Lcom/android/server/wm/DisplayFrames;->mDock:Landroid/graphics/Rect;

    iget v1, v1, Landroid/graphics/Rect;->right:I

    iget-object v3, p0, Lcom/android/server/wm/cgv;->KV:Landroid/view/WindowManager$LayoutParams;
    ...
    sget v4, Lcom/android/server/wm/cgv;->GW:I

    sub-int/2addr v3, v4

    sget v5, Lcom/android/server/wm/cgv;->sIMELimitWidth:I

    sub-int/2addr v3, v5

    sget v5, Lcom/android/server/wm/cgv;->xW:I
    ...
    iput v1, p0, Lcom/android/server/wm/cgv;->XV:I

    iput v2, p0, Lcom/android/server/wm/cgv;->WV:I
    ...
    iget v2, p0, Lcom/android/server/wm/cgv;->WV:I

    if-le v1, v2, :cond_3

    iput v1, p0, Lcom/android/server/wm/cgv;->WV:I
    ...
    iget-object v2, p0, Lcom/android/server/wm/cgv;->mDisplayFrames:Lcom/android/server/wm/DisplayFrames;
    ...
    iget-object v2, p0, Lcom/android/server/wm/cgv;->KV:Landroid/view/WindowManager$LayoutParams;
    ...
    sget v3, Lcom/android/server/wm/cgv;->HW:I

    add-int/2addr v2, v3

    sget v4, Lcom/android/server/wm/cgv;->sIMELimitWidth:I
    ...
    sget v2, Lcom/android/server/wm/cgv;->xW:I

    sub-int/2addr v1, v2

    iput v1, p0, Lcom/android/server/wm/cgv;->XV:I

    iget v1, p0, Lcom/android/server/wm/cgv;->XV:I
    ...
    iput v3, p0, Lcom/android/server/wm/cgv;->XV:I
    ...
    sget v3, Lcom/android/server/wm/cgv;->xW:I
    ...
    iput v2, p0, Lcom/android/server/wm/cgv;->XV:I

    :cond_8
    :goto_0
    iget v1, p0, Lcom/android/server/wm/cgv;->VV:I
    ...
    iget v2, p0, Lcom/android/server/wm/cgv;->mScreenWidth:I

    sget v3, Lcom/android/server/wm/cgv;->IW:I
...
.method private Kq()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/server/wm/cgv;->OV:Lcom/android/server/wm/ActivityRecord;
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/wm/cgv;->isQuickReplyIM(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0}, Lcom/android/server/wm/cgv;->getImBound()Landroid/graphics/Rect;
...
.method private Na(Z)V
    ...
    sput p1, Lcom/android/server/wm/cgv;->IW:I
    ...
    iget-object p1, p0, Lcom/android/server/wm/cgv;->FV:Lcom/android/server/wm/WindowManagerService;
    ...
    iput p1, p0, Lcom/android/server/wm/cgv;->UV:I
    ...
    iget p0, p0, Lcom/android/server/wm/cgv;->UV:I
    ...
    sget p1, Lcom/android/server/wm/cgv;->IW:I
...
.method private Xb(I)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/cgv;->KV:Landroid/view/WindowManager$LayoutParams;

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p1, Landroid/view/WindowManager$LayoutParams;->alpha:F

    iget-object p1, p0, Lcom/android/server/wm/cgv;->mContext:Landroid/content/Context;
    ...
    iput-object p1, p0, Lcom/android/server/wm/cgv;->bW:Landroid/view/View;
    ...
    iput-object p1, p0, Lcom/android/server/wm/cgv;->eW:Landroid/widget/FrameLayout;
    ...
    iput-object p1, p0, Lcom/android/server/wm/cgv;->fW:Landroid/widget/FrameLayout;

    iget-object p1, p0, Lcom/android/server/wm/cgv;->fW:Landroid/widget/FrameLayout;

    new-instance v0, Lcom/android/server/wm/fto;

    invoke-direct {v0, p0}, Lcom/android/server/wm/fto;-><init>(Lcom/android/server/wm/cgv;)V
    ...
    invoke-direct {v0, p0}, Lcom/android/server/wm/lqr;-><init>(Lcom/android/server/wm/cgv;)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/cgv;->MV:Lcom/android/server/wm/cgv$zta;

    const/4 v0, 0x5

    invoke-virtual {p1, v0}, Landroid/os/Handler;->removeMessages(I)V

    iget-object p0, p0, Lcom/android/server/wm/cgv;->MV:Lcom/android/server/wm/cgv$zta;
...
.method private Zb(I)V
    ...
    iget-object p0, p0, Lcom/android/server/wm/cgv;->bW:Landroid/view/View;
...
.method static synthetic bvj(Lcom/android/server/wm/cgv;)Lcom/android/server/wm/cgv$zta;
    .locals 0
...
.method public static getInstance(Landroid/content/Context;)Lcom/android/server/wm/cgv;
    .locals 2

    const-class v0, Lcom/android/server/wm/cgv;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/android/server/wm/cgv;->sInstance:Lcom/android/server/wm/cgv;

    if-nez v1, :cond_0

    new-instance v1, Lcom/android/server/wm/cgv;

    invoke-direct {v1, p0}, Lcom/android/server/wm/cgv;-><init>(Landroid/content/Context;)V

    sput-object v1, Lcom/android/server/wm/cgv;->sInstance:Lcom/android/server/wm/cgv;

    :cond_0
    sget-object p0, Lcom/android/server/wm/cgv;->sInstance:Lcom/android/server/wm/cgv;
...
.method private getWindowManager()Landroid/view/WindowManager;
    ...
    iget-object v0, p0, Lcom/android/server/wm/cgv;->mWindowManager:Landroid/view/WindowManager;
    ...
    iput-object v0, p0, Lcom/android/server/wm/cgv;->mWindowManager:Landroid/view/WindowManager;

    :cond_0
    iget-object p0, p0, Lcom/android/server/wm/cgv;->mWindowManager:Landroid/view/WindowManager;

    return-object p0
.end method

.method static synthetic gwm(Lcom/android/server/wm/cgv;)Landroid/view/WindowManager$LayoutParams;
    .locals 0
...
.method static synthetic ibl(Lcom/android/server/wm/cgv;)I
    .locals 0

    iget p0, p0, Lcom/android/server/wm/cgv;->VV:I
...
.method private init()V
    ...
    iput-object v0, p0, Lcom/android/server/wm/cgv;->RV:Lcom/android/internal/view/IInputMethodManager;
    ...
    new-instance v1, Lcom/android/server/wm/cgv$zta;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v0

    invoke-direct {v1, p0, v0}, Lcom/android/server/wm/cgv$zta;-><init>(Lcom/android/server/wm/cgv;Landroid/os/Looper;)V

    iput-object v1, p0, Lcom/android/server/wm/cgv;->MV:Lcom/android/server/wm/cgv$zta;

    new-instance v0, Lcom/android/server/wm/cgv$sis;

    iget-object v1, p0, Lcom/android/server/wm/cgv;->MV:Lcom/android/server/wm/cgv$zta;

    invoke-direct {v0, p0, v1}, Lcom/android/server/wm/cgv$sis;-><init>(Lcom/android/server/wm/cgv;Lcom/android/server/wm/cgv$zta;)V
...
.method static synthetic oif(Lcom/android/server/wm/cgv;)Lcom/android/server/wm/ActivityRecord;
    .locals 0

    iget-object p0, p0, Lcom/android/server/wm/cgv;->OV:Lcom/android/server/wm/ActivityRecord;
...
.method static synthetic sis(Lcom/android/server/wm/cgv;I)I
    .locals 0

    iput p1, p0, Lcom/android/server/wm/cgv;->VV:I
...
.method static synthetic tsu(Lcom/android/server/wm/cgv;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/server/wm/cgv;->DV:Z

    return p0
.end method

.method static synthetic ugm(Lcom/android/server/wm/cgv;)I
    .locals 0

    iget p0, p0, Lcom/android/server/wm/cgv;->XV:I
...
.method private updateSettings()V
    ...
    :goto_0
    iget-boolean v2, p0, Lcom/android/server/wm/cgv;->QV:Z
...
.method static synthetic vdb(Lcom/android/server/wm/cgv;)I
    .locals 0

    iget p0, p0, Lcom/android/server/wm/cgv;->WV:I
...
.method private xq()V
    ...
    iput-object v0, p0, Lcom/android/server/wm/cgv;->mPerfLock:Lcom/oneplus/sdk/utils/OpBoostFramework;

    :cond_0
    iget-object p0, p0, Lcom/android/server/wm/cgv;->mPerfLock:Lcom/oneplus/sdk/utils/OpBoostFramework;
...
.method private yq()V
    ...
    iput-object v0, p0, Lcom/android/server/wm/cgv;->aW:Landroid/view/View;

    iget-object v0, p0, Lcom/android/server/wm/cgv;->aW:Landroid/view/View;

    new-instance v3, Lcom/android/server/wm/cjf;

    invoke-direct {v3, p0}, Lcom/android/server/wm/cjf;-><init>(Lcom/android/server/wm/cgv;)V
    ...
    invoke-direct {v3, p0}, Lcom/android/server/wm/ear;-><init>(Lcom/android/server/wm/cgv;)V
    ...
    iget-object v3, p0, Lcom/android/server/wm/cgv;->aW:Landroid/view/View;

    iget-object v4, p0, Lcom/android/server/wm/cgv;->GV:Landroid/view/WindowManager$LayoutParams;
    ...
    iput-object v0, p0, Lcom/android/server/wm/cgv;->cW:Landroid/view/View;

    iget-object v0, p0, Lcom/android/server/wm/cgv;->cW:Landroid/view/View;

    new-instance v1, Lcom/android/server/wm/ire;

    invoke-direct {v1, p0}, Lcom/android/server/wm/ire;-><init>(Lcom/android/server/wm/cgv;)V
    ...
    iget-object v3, p0, Lcom/android/server/wm/cgv;->HV:Landroid/view/WindowManager$LayoutParams;
    ...
    iput-object v0, p0, Lcom/android/server/wm/cgv;->dW:Landroid/view/View;

    iget-object v0, p0, Lcom/android/server/wm/cgv;->dW:Landroid/view/View;

    new-instance v1, Lcom/android/server/wm/hmo;

    invoke-direct {v1, p0}, Lcom/android/server/wm/hmo;-><init>(Lcom/android/server/wm/cgv;)V
...
.method static synthetic ywr(Lcom/android/server/wm/cgv;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/wm/cgv;->updateSettings()V
...
.method private ywr(Lorg/json/JSONArray;)V
    ...
    :cond_5
    sget-object p1, Lcom/android/server/wm/cgv;->gW:Ljava/lang/Object;
    ...
    sput-object p0, Lcom/android/server/wm/cgv;->PW:Ljava/util/List;
...
.method static synthetic zta(Lcom/android/server/wm/cgv;)Landroid/content/Context;
    .locals 0

    iget-object p0, p0, Lcom/android/server/wm/cgv;->mContext:Landroid/content/Context;
...
.method private zta(Landroid/os/IBinder;)V
    ...
    :cond_0
    iget-object v1, p0, Lcom/android/server/wm/cgv;->FV:Lcom/android/server/wm/WindowManagerService;
...
.method private zta(Landroid/os/IBinder;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/wm/cgv;->isQuickReplyIM(Lcom/android/server/wm/AppWindowToken;)Z
    ...
    :cond_2
    invoke-virtual {p0, p1}, Lcom/android/server/wm/cgv;->setQuickReplyRunning(Z)V
...
.method private zta(Lcom/android/server/wm/ActivityRecord;)V
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/cgv;->DV:Z

    if-nez v0, :cond_5

    iget-object p1, p1, Lcom/android/server/wm/ActivityRecord;->packageName:Ljava/lang/String;

    invoke-virtual {p0, p1}, Lcom/android/server/wm/cgv;->isQuickReplyIME(Ljava/lang/String;)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/wm/cgv;->EV:Z

    iget-object p1, p0, Lcom/android/server/wm/cgv;->PV:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Lcom/android/server/wm/cgv;->OV:Lcom/android/server/wm/ActivityRecord;
...
.method static synthetic zta(Lcom/android/server/wm/cgv;I)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/wm/cgv;->Xb(I)V

    return-void
.end method

.method static synthetic zta(Lcom/android/server/wm/cgv;Landroid/os/IBinder;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/wm/cgv;->zta(Landroid/os/IBinder;)V

    return-void
.end method

.method static synthetic zta(Lcom/android/server/wm/cgv;Lcom/android/server/wm/ActivityRecord;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/wm/cgv;->zta(Lcom/android/server/wm/ActivityRecord;)V

    return-void
.end method

.method static synthetic zta(Lcom/android/server/wm/cgv;Lorg/json/JSONArray;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/wm/cgv;->ywr(Lorg/json/JSONArray;)V

    return-void
.end method

.method static synthetic zta(Lcom/android/server/wm/cgv;Z)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/wm/cgv;->Na(Z)V
...
.method private zta(Lcom/android/server/wm/WindowState;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/wm/cgv;->isQuickReplyIME(Ljava/lang/String;)Z
    ...
    sget p1, Lcom/android/server/wm/cgv;->sIMELimitWidth:I

    sget v0, Lcom/android/server/wm/cgv;->MW:I
...
.method private zta(Ljava/lang/String;Lcom/android/server/wm/WindowState;)Z
    ...
    sget v2, Lcom/android/server/wm/cgv;->sIMELimitWidth:I
    ...
    invoke-direct {p0, p2}, Lcom/android/server/wm/cgv;->zta(Lcom/android/server/wm/WindowState;)Z
...
.method public bootComplete()V
    ...
    iget-object v0, p0, Lcom/android/server/wm/cgv;->SV:Lcom/oneplus/config/ConfigObserver;
    ...
    iget-object v2, p0, Lcom/android/server/wm/cgv;->mContext:Landroid/content/Context;

    iget-object v3, p0, Lcom/android/server/wm/cgv;->MV:Lcom/android/server/wm/cgv$zta;

    new-instance v4, Lcom/android/server/wm/cgv$you;

    invoke-direct {v4, p0}, Lcom/android/server/wm/cgv$you;-><init>(Lcom/android/server/wm/cgv;)V
    ...
    iput-object v0, p0, Lcom/android/server/wm/cgv;->SV:Lcom/oneplus/config/ConfigObserver;
    ...
    invoke-direct {p0, v0}, Lcom/android/server/wm/cgv;->ywr(Lorg/json/JSONArray;)V
...
.method public checkAndAddWindow(Lcom/android/server/wm/WindowState;Lcom/android/server/wm/DisplayContent;)V
    ...
    invoke-virtual {p0}, Lcom/android/server/wm/cgv;->isQuickReplyRunning()Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-virtual {p0, p1}, Lcom/android/server/wm/cgv;->isQuickReplyIMEWin(Lcom/android/server/wm/WindowState;)Z
...
.method public exitQuickReply()V
    ...
    :cond_0
    iget-object v2, p0, Lcom/android/server/wm/cgv;->MV:Lcom/android/server/wm/cgv$zta;
...
.method public focusChangedLw(Lcom/android/server/wm/WindowState;Lcom/android/server/wm/WindowState;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/wm/cgv;->zta(Ljava/lang/String;Lcom/android/server/wm/WindowState;)Z
    ...
    :cond_0
    iget-boolean p1, p0, Lcom/android/server/wm/cgv;->DV:Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/wm/cgv;->isQuickReplyIM(Ljava/lang/String;)Z
...
.method public getImBound()Landroid/graphics/Rect;
    ...
    sget v3, Lcom/android/server/wm/cgv;->vW:I
    ...
    iget p0, p0, Lcom/android/server/wm/cgv;->mScreenWidth:I

    sget v1, Lcom/android/server/wm/cgv;->IW:I
...
.method public getQuickReplyList(I)Ljava/util/List;
    ...
    :cond_0
    iget-boolean p0, p0, Lcom/android/server/wm/cgv;->QV:Z

    if-eqz p0, :cond_1

    sget-object v1, Lcom/android/server/wm/cgv;->PW:Ljava/util/List;

    :cond_1
    return-object v1

    :cond_2
    sget-object p0, Lcom/android/server/wm/cgv;->OW:Ljava/util/List;
...
.method public getQuickReplyOrientation(Lcom/android/server/wm/TaskStack;Lcom/android/server/wm/AppWindowToken;)I
    ...
    invoke-virtual {p0, p2}, Lcom/android/server/wm/cgv;->isQuickReplyIM(Lcom/android/server/wm/AppWindowToken;)Z
...
.method public isInCameraActivityList(Ljava/lang/String;)Z
    ...
    sget-object p0, Lcom/android/server/wm/cgv;->QW:Ljava/util/List;
...
.method public isQuickReplyExiting()Z
    ...
    iget-boolean p0, p0, Lcom/android/server/wm/cgv;->EV:Z
...
.method public isQuickReplyIM(Lcom/android/server/wm/AppWindowToken;)Z
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/wm/cgv;->isQuickReplyIM(Ljava/lang/String;)Z
...
.method public isQuickReplyIM(Ljava/lang/String;)Z
    ...
    sget-object v0, Lcom/android/server/wm/cgv;->NW:Ljava/util/List;
    ...
    sget-object v0, Lcom/android/server/wm/cgv;->OW:Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/android/server/wm/cgv;->_V:Ljava/util/List;
...
.method public isQuickReplyIMWin(Lcom/android/server/wm/WindowState;)Z
    ...
    iget-boolean v2, p0, Lcom/android/server/wm/cgv;->DV:Z
...
.method public killApplicationProcess(Lcom/android/server/wm/ActivityTaskManagerService;Landroid/content/pm/ActivityInfo;)V
    ...
    invoke-direct {v1, p0, p1, p2}, Lcom/android/server/wm/veq;-><init>(Lcom/android/server/wm/cgv;Lcom/android/server/wm/ActivityTaskManagerService;Landroid/content/pm/ActivityInfo;)V
...
.method public notifyImeShow(Ljava/lang/String;)V
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/cgv;->QV:Z
    ...
    iget-object v0, p0, Lcom/android/server/wm/cgv;->YV:Landroid/util/ArrayMap;
    ...
    invoke-direct {v2, p0, p1, v0}, Lcom/android/server/wm/obl;-><init>(Lcom/android/server/wm/cgv;Ljava/lang/String;Ljava/lang/Integer;)V
...
.method public notifyImeVisibilityChanged(ZI)V
    ...
    iget p2, p0, Lcom/android/server/wm/cgv;->mScreenWidth:I
...
.method public setDisplayFrames(Lcom/android/server/wm/DisplayFrames;)V
    ...
    iput-object p1, p0, Lcom/android/server/wm/cgv;->mDisplayFrames:Lcom/android/server/wm/DisplayFrames;
...
.method public setKeyguardDone(Z)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/cgv;->OV:Lcom/android/server/wm/ActivityRecord;
...
.method public setQuickReplyRunning(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/server/wm/cgv;->DV:Z

    iget-object v0, p0, Lcom/android/server/wm/cgv;->MV:Lcom/android/server/wm/cgv$zta;

    new-instance v1, Lcom/android/server/wm/oxb;

    invoke-direct {v1, p0}, Lcom/android/server/wm/oxb;-><init>(Lcom/android/server/wm/cgv;)V
...
.method public setResumedApp(Lcom/android/server/wm/ActivityRecord;)V
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/server/wm/cgv;->zta(Landroid/os/IBinder;Ljava/lang/String;)V

    iget-boolean v1, p0, Lcom/android/server/wm/cgv;->DV:Z

    if-eqz v1, :cond_1

    iget-object v1, p0, Lcom/android/server/wm/cgv;->PV:Ljava/util/ArrayList;
    ...
    :cond_2
    :goto_0
    iput-object p1, p0, Lcom/android/server/wm/cgv;->OV:Lcom/android/server/wm/ActivityRecord;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public systemReady()V
    ...
    invoke-direct {p0}, Lcom/android/server/wm/cgv;->init()V
    ...
    iput v0, p0, Lcom/android/server/wm/cgv;->VV:I
...
.method public updateIMEFrameIfNeeded(Ljava/lang/String;Lcom/android/server/wm/WindowState;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    sget p2, Lcom/android/server/wm/cgv;->xW:I
