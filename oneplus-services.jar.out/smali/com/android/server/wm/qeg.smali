...
.field private static final _V:I = 0x3
...
.field private WV:Landroid/graphics/Color;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, Lcom/android/server/wm/qeg;->UV:I

    iput v0, p0, Lcom/android/server/wm/qeg;->VV:I

    new-instance v0, Landroid/graphics/Color;

    invoke-direct {v0}, Landroid/graphics/Color;-><init>()V

    iput-object v0, p0, Lcom/android/server/wm/qeg;->WV:Landroid/graphics/Color;
...
.method private sis(F)Landroid/graphics/Color;
    ...
    iget v0, p0, Lcom/android/server/wm/qeg;->UV:I

    invoke-static {v0}, Landroid/graphics/Color;->valueOf(I)Landroid/graphics/Color;

    move-result-object v0

    iget p0, p0, Lcom/android/server/wm/qeg;->VV:I
...
.method public init(Lcom/android/server/wm/DisplayContent;ZZLcom/android/server/wm/WindowManagerService;Landroid/view/SurfaceControl;Landroid/view/SurfaceControl$ScreenshotGraphicBuffer;)V
    ...
    iput p3, p0, Lcom/android/server/wm/qeg;->XV:I
    ...
    iput p2, p0, Lcom/android/server/wm/qeg;->UV:I
...
.method public initBlackFrame(Landroid/view/SurfaceControl$Transaction;ZIIZ)Lcom/android/server/wm/BlackFrame;
    ...
    iget p0, p0, Lcom/android/server/wm/qeg;->UV:I
...
.method public stepAnimation(JILandroid/view/animation/Animation;)V
    ...
    iput-object p1, p0, Lcom/android/server/wm/qeg;->WV:Landroid/graphics/Color;

    iget p1, p0, Lcom/android/server/wm/qeg;->XV:I

    const/4 p2, 0x1

    add-int/2addr p1, p2

    iput p1, p0, Lcom/android/server/wm/qeg;->XV:I
    ...
    iput p2, p0, Lcom/android/server/wm/qeg;->VV:I
    ...
    :cond_4
    :goto_3
    iget p1, p0, Lcom/android/server/wm/qeg;->UV:I

    iput p1, p0, Lcom/android/server/wm/qeg;->VV:I
    ...
    iget p2, p0, Lcom/android/server/wm/qeg;->UV:I
...
.method public updateEnteringBlackFrame(Landroid/view/SurfaceControl$Transaction;Lcom/android/server/wm/BlackFrame;)Lcom/android/server/wm/BlackFrame;
    ...
    iget-object v1, p0, Lcom/android/server/wm/qeg;->WV:Landroid/graphics/Color;
    ...
    iget-object p0, p0, Lcom/android/server/wm/qeg;->WV:Landroid/graphics/Color;
