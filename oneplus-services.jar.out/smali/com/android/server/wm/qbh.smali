...
.field static final yQ:I = 0x1eab92
...
.field nQ:Landroid/view/SurfaceControl;
...
.field private final xQ:Landroid/view/animation/Interpolator;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/DisplayContent;ZZLcom/android/server/wm/WindowManagerService;I)V
    ...
    iput-boolean v7, v1, Lcom/android/server/wm/qbh;->oQ:Z

    iput-boolean v6, v1, Lcom/android/server/wm/qbh;->pQ:Z

    iput-boolean v6, v1, Lcom/android/server/wm/qbh;->qQ:Z

    iput-boolean v6, v1, Lcom/android/server/wm/qbh;->rQ:Z

    iput-boolean v6, v1, Lcom/android/server/wm/qbh;->sQ:Z

    iput-boolean v6, v1, Lcom/android/server/wm/qbh;->tQ:Z

    iput-boolean v6, v1, Lcom/android/server/wm/qbh;->uQ:Z

    invoke-static {}, Lcom/android/server/policy/OpPhoneWindowManagerInjector;->isGestureButtonEnabled()Z

    move-result v8

    iput-boolean v8, v1, Lcom/android/server/wm/qbh;->vQ:Z
    ...
    iput-object v8, v1, Lcom/android/server/wm/qbh;->xQ:Landroid/view/animation/Interpolator;
    ...
    iput v4, v1, Lcom/android/server/wm/qbh;->wQ:I
    ...
    :pswitch_1
    iput-boolean v7, v1, Lcom/android/server/wm/qbh;->rQ:Z

    goto :goto_0

    :pswitch_2
    iput-boolean v6, v1, Lcom/android/server/wm/qbh;->oQ:Z
    ...
    :goto_0
    iget-boolean v11, v1, Lcom/android/server/wm/qbh;->rQ:Z
    ...
    iput-boolean v7, v1, Lcom/android/server/wm/qbh;->qQ:Z
    ...
    iput-boolean v7, v1, Lcom/android/server/wm/qbh;->pQ:Z
    ...
    iput-boolean v7, v1, Lcom/android/server/wm/qbh;->uQ:Z
    ...
    iput-boolean v7, v1, Lcom/android/server/wm/qbh;->sQ:Z
    ...
    iput-boolean v7, v1, Lcom/android/server/wm/qbh;->tQ:Z
    ...
    invoke-static {}, Lcom/android/server/wm/ywr;->de()Lcom/android/server/wm/AppWindowToken;
    ...
    invoke-static {}, Lcom/android/server/wm/ywr;->ee()Lcom/android/server/wm/AppWindowToken;
    ...
    iget-boolean v5, v1, Lcom/android/server/wm/qbh;->pQ:Z
    ...
    iget-boolean v5, v1, Lcom/android/server/wm/qbh;->qQ:Z
    ...
    iget-boolean v5, v1, Lcom/android/server/wm/qbh;->uQ:Z
    ...
    iget-boolean v5, v1, Lcom/android/server/wm/qbh;->oQ:Z
    ...
    iget-boolean v5, v1, Lcom/android/server/wm/qbh;->rQ:Z
    ...
    iget-boolean v5, v1, Lcom/android/server/wm/qbh;->sQ:Z
    ...
    iget-boolean v5, v1, Lcom/android/server/wm/qbh;->tQ:Z
    ...
    :try_start_0
    iget-boolean v10, v1, Lcom/android/server/wm/qbh;->pQ:Z
    :try_end_0
    ...
    :try_start_1
    iget-boolean v10, v1, Lcom/android/server/wm/qbh;->rQ:Z
    ...
    iput-object v2, v1, Lcom/android/server/wm/qbh;->nQ:Landroid/view/SurfaceControl;
    ...
    :goto_d
    iget-object v0, v1, Lcom/android/server/wm/qbh;->nQ:Landroid/view/SurfaceControl;
...
.method private startAnimation(Landroid/view/SurfaceControl$Transaction;JFIIZII)Z
    ...
    iget-object v6, v0, Lcom/android/server/wm/qbh;->nQ:Landroid/view/SurfaceControl;
    ...
    :cond_4
    iget-boolean v12, v0, Lcom/android/server/wm/qbh;->rQ:Z
    ...
    :cond_5
    iget-boolean v12, v0, Lcom/android/server/wm/qbh;->tQ:Z
    ...
    :cond_6
    iget-boolean v4, v0, Lcom/android/server/wm/qbh;->sQ:Z
    ...
    :cond_7
    iget-boolean v4, v0, Lcom/android/server/wm/qbh;->pQ:Z
    ...
    :cond_8
    iget-boolean v4, v0, Lcom/android/server/wm/qbh;->qQ:Z

    if-eqz v4, :cond_b

    iget-boolean v4, v0, Lcom/android/server/wm/qbh;->vQ:Z

    if-eqz v4, :cond_a

    iget-boolean v4, v0, Lcom/android/server/wm/qbh;->uQ:Z
    ...
    :cond_b
    iget-boolean v4, v0, Lcom/android/server/wm/qbh;->oQ:Z
    ...
    iget-boolean v6, v0, Lcom/android/server/wm/qbh;->pQ:Z
...
.method private zta(IZLandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Point;)Landroid/view/animation/Animation;
    ...
    iget-object v2, v0, Lcom/android/server/wm/qbh;->xQ:Landroid/view/animation/Interpolator;
...
.method private zta(Landroid/view/SurfaceControl$Transaction;Landroid/graphics/Matrix;F)V
    ...
    iget-object v0, p0, Lcom/android/server/wm/qbh;->nQ:Landroid/view/SurfaceControl;
    ...
    :cond_0
    iget-object v1, p0, Lcom/android/server/wm/qbh;->nQ:Landroid/view/SurfaceControl;
    ...
    iget-object v3, p0, Lcom/android/server/wm/qbh;->nQ:Landroid/view/SurfaceControl;
    ...
    iget-object p0, p0, Lcom/android/server/wm/qbh;->nQ:Landroid/view/SurfaceControl;
...
.method public dismiss(Landroid/view/SurfaceControl$Transaction;JFIIII)Z
    ...
    iget-object v0, v10, Lcom/android/server/wm/qbh;->nQ:Landroid/view/SurfaceControl;
...
.method public kill()V
    ...
    iput-object v1, p0, Lcom/android/server/wm/qbh;->nQ:Landroid/view/SurfaceControl;
...
.method public printTo(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/qbh;->oQ:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/qbh;->pQ:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/qbh;->qQ:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/qbh;->uQ:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/qbh;->rQ:Z
    ...
    iget-boolean v0, p0, Lcom/android/server/wm/qbh;->sQ:Z
    ...
    iget-boolean p0, p0, Lcom/android/server/wm/qbh;->tQ:Z
