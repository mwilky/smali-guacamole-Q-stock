...
.field private static QR:Lcom/android/server/wm/AppWindowToken; = null

.field private static RR:Lcom/android/server/wm/AppWindowToken; = null

.field private static final TAG:Ljava/lang/String; = "OpDisplayContent"


# instance fields
.field private OR:Landroid/view/SurfaceControl;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/wm/qbh;->DEBUG:Z

    const/4 v0, 0x0

    sput-object v0, Lcom/android/server/wm/qbh;->QR:Lcom/android/server/wm/AppWindowToken;

    sput-object v0, Lcom/android/server/wm/qbh;->RR:Lcom/android/server/wm/AppWindowToken;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/wm/qbh;->mSession:Landroid/view/SurfaceSession;
...
.method public static ke()Lcom/android/server/wm/AppWindowToken;
    ...
    sget-object v0, Lcom/android/server/wm/qbh;->QR:Lcom/android/server/wm/AppWindowToken;
...
.method public static le()Lcom/android/server/wm/AppWindowToken;
    ...
    sget-object v0, Lcom/android/server/wm/qbh;->RR:Lcom/android/server/wm/AppWindowToken;
...
.method public handleAppTransitionReady()I
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/wm/qbh;->setBooleanNotificationRemoteInputeDraft(Z)V
...
.method public init(Lcom/android/server/wm/WindowManagerService;Landroid/view/Display;Lcom/android/server/wm/DisplayContent;)V
    ...
    iput-object p1, p0, Lcom/android/server/wm/qbh;->mWindowManager:Lcom/android/server/wm/WindowManagerService;

    iput-object p2, p0, Lcom/android/server/wm/qbh;->mDisplay:Landroid/view/Display;

    invoke-virtual {p2}, Landroid/view/Display;->getDisplayId()I

    move-result p1

    iput p1, p0, Lcom/android/server/wm/qbh;->mDisplayId:I

    iput-object p3, p0, Lcom/android/server/wm/qbh;->mDisplayContent:Lcom/android/server/wm/DisplayContent;

    iget-object p1, p0, Lcom/android/server/wm/qbh;->mWindowManager:Lcom/android/server/wm/WindowManagerService;

    iget-object p2, p0, Lcom/android/server/wm/qbh;->mSession:Landroid/view/SurfaceSession;
    ...
    iput-object p1, p0, Lcom/android/server/wm/qbh;->OR:Landroid/view/SurfaceControl;

    iget-object p1, p0, Lcom/android/server/wm/qbh;->mDisplayContent:Lcom/android/server/wm/DisplayContent;

    invoke-virtual {p1}, Lcom/android/server/wm/DisplayContent;->getPendingTransaction()Landroid/view/SurfaceControl$Transaction;

    move-result-object p1

    iget-object p2, p0, Lcom/android/server/wm/qbh;->OR:Landroid/view/SurfaceControl;
    ...
    iget p3, p0, Lcom/android/server/wm/qbh;->mDisplayId:I
    ...
    iget-object p0, p0, Lcom/android/server/wm/qbh;->OR:Landroid/view/SurfaceControl;
...
.method public makeCovered()Landroid/view/SurfaceControl$Builder;
    ...
    iget-object v0, p0, Lcom/android/server/wm/qbh;->mWindowManager:Lcom/android/server/wm/WindowManagerService;

    iget-object v1, p0, Lcom/android/server/wm/qbh;->mSession:Landroid/view/SurfaceSession;
...
.method public prepareSurfaces()V
    ...
    iget v1, p0, Lcom/android/server/wm/qbh;->mDisplayId:I
    ...
    iget-object p0, p0, Lcom/android/server/wm/qbh;->mDisplayContent:Lcom/android/server/wm/DisplayContent;
    ...
    sget-boolean p0, Lcom/android/server/wm/qbh;->DEBUG:Z
...
.method public removeImmediately()V
    ...
    sget-boolean v0, Lcom/android/server/wm/qbh;->DEBUG:Z
...
.method public setFocusedApp(Lcom/android/server/wm/AppWindowToken;)V
    ...
    sput-object p0, Lcom/android/server/wm/qbh;->RR:Lcom/android/server/wm/AppWindowToken;
...
.method public setSourceBoundFromIntent(Landroid/content/Intent;)V
    ...
    :cond_2
    sget-boolean v1, Lcom/android/server/wm/qbh;->DEBUG:Z
