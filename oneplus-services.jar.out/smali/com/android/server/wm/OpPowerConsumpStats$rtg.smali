...
.field WQ:Lcom/android/server/wm/OpPowerConsumpStats$wtn;
...
.method constructor <init>(Lcom/android/server/wm/OpPowerConsumpStats;)V
    ...
    iput-boolean p1, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->CQ:Z

    iput-boolean p1, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->VQ:Z
    ...
    iput-object p1, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->WQ:Lcom/android/server/wm/OpPowerConsumpStats$wtn;
...
.method private Gb(I)Z
    ...
    :try_start_0
    iget-boolean v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->CQ:Z
    ...
    iput-boolean v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->CQ:Z
    ...
    iget-object v3, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->WQ:Lcom/android/server/wm/OpPowerConsumpStats$wtn;

    invoke-static {v3}, Lcom/android/server/wm/OpPowerConsumpStats$wtn;->sis(Lcom/android/server/wm/OpPowerConsumpStats$wtn;)V

    iput-boolean v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->VQ:Z
    ...
    iput-wide v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->MQ:J
    ...
    iput-wide v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->OQ:J
    ...
    iput v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->PQ:I
    ...
    iput-object p1, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->UQ:Ljava/lang/String;
    ...
    iget-object p1, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->WQ:Lcom/android/server/wm/OpPowerConsumpStats$wtn;

    iget-object v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$tsu;

    iget-wide v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->MQ:J
    ...
    iput-boolean v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->VQ:Z
    ...
    iget-wide v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->OQ:J
    ...
    iget v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->PQ:I
...
.method private clear()V
    ...
    iget-object v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->WQ:Lcom/android/server/wm/OpPowerConsumpStats$wtn;
...
.method static synthetic cno(Lcom/android/server/wm/OpPowerConsumpStats$rtg;)Lcom/android/server/wm/OpPowerConsumpStats$tsu;
    ...
    invoke-direct {p0}, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->gp()Lcom/android/server/wm/OpPowerConsumpStats$tsu;
...
.method private gp()Lcom/android/server/wm/OpPowerConsumpStats$tsu;
    .locals 6
    ...
    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->MQ:J
    ...
    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->NQ:J

    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->NQ:J

    iget-wide v4, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->MQ:J
    ...
    iput v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->PQ:I
    ...
    iput v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->RQ:I

    iget-object v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$tsu;

    iget-object v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->UQ:Ljava/lang/String;

    iput-object v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->UQ:Ljava/lang/String;

    iget-object v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$tsu;

    iget-wide v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->TQ:J

    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->TQ:J

    iget-object p0, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->WQ:Lcom/android/server/wm/OpPowerConsumpStats$wtn;
    ...
    iput-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->SQ:J
    ...
    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->MQ:J
    ...
    iget v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->PQ:I
    ...
    iget v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->RQ:I
    ...
    iget-object v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->UQ:Ljava/lang/String;
    ...
    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->TQ:J
    ...
    iget-wide v2, v1, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->SQ:J
...
.method private jp()Z
    ...
    :cond_0
    iput-boolean v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->CQ:Z
    ...
    iget-wide v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->NQ:J

    iget-object v4, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$tsu;

    iget-wide v4, v4, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->MQ:J
    ...
    iget-object v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->WQ:Lcom/android/server/wm/OpPowerConsumpStats$wtn;

    iget-object v3, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->fragment:Lcom/android/server/wm/OpPowerConsumpStats$tsu;

    iget-wide v3, v3, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->NQ:J
    ...
    iget-object v2, v2, Lcom/android/server/wm/OpPowerConsumpStats;->YR:Ljava/util/ArrayList;
    ...
    iget v2, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->RQ:I
    ...
    iget-wide v2, p0, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->SQ:J
...
.method private kp()Z
    ...
    :cond_0
    iget-boolean v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->VQ:Z
    ...
    iget-wide v5, v5, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->MQ:J

    sub-long/2addr v3, v5

    iput-wide v3, v2, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->TQ:J
    ...
    iget-wide v3, p0, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->TQ:J
...
.method private lp()Z
    ...
    iput-object v1, p0, Lcom/android/server/wm/OpPowerConsumpStats$tsu;->UQ:Ljava/lang/String;
...
.method static synthetic rtg(Lcom/android/server/wm/OpPowerConsumpStats$rtg;)Z
    ...
    invoke-direct {p0}, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->kp()Z
...
.method static synthetic sis(Lcom/android/server/wm/OpPowerConsumpStats$rtg;)V
    ...
    invoke-direct {p0}, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->hp()V
...
.method static synthetic tsu(Lcom/android/server/wm/OpPowerConsumpStats$rtg;)Z
    ...
    invoke-direct {p0}, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->lp()Z
...
.method static synthetic you(Lcom/android/server/wm/OpPowerConsumpStats$rtg;)V
    ...
    invoke-direct {p0}, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->ip()V
...
.method static synthetic zta(Lcom/android/server/wm/OpPowerConsumpStats$rtg;I)Z
    ...
    invoke-direct {p0, p1}, Lcom/android/server/wm/OpPowerConsumpStats$rtg;->Gb(I)Z
