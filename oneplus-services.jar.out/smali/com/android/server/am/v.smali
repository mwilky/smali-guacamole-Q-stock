...
.field private static Fy:Lcom/android/server/am/v; = null

.field private static Gy:Ljava/util/HashMap; = null
...
.field private static Ly:Z = false
...
.field private static Ty:J = 0x0L

.field private static Uy:I = 0x0

.field private static Vy:D = 0.0
...
.field private static az:I = 0x0

.field public static final iy:Ljava/lang/String; = "Ultra Used Packages"

.field public static final jy:Ljava/lang/String; = "High Used Packages"

.field public static final ky:Ljava/lang/String; = "General Used Packages"

.field public static final ly:Ljava/lang/String; = "Seldom Used Packages"

.field public static final my:Ljava/lang/String; = "Low Used Packages"

.field public static final ny:Ljava/lang/String; = "persist.sys.rp.enable"

.field public static final oy:Ljava/lang/String; = "persist.sys.rp.enableall"

.field public static final py:Ljava/lang/String; = "OpRestartProcessManager"

.field public static final qy:Ljava/lang/String; = "record.txt"

.field public static final ry:Ljava/lang/String; = "record_backup.txt"

.field private static final sy:Ljava/lang/String; = "valid_duration"

.field private static final ty:Ljava/lang/String; = "general_duration"

.field private static final uy:Ljava/lang/String; = "enable_module"

.field private static final vy:Ljava/lang/String; = "enable_all_module"

.field public static wy:Z

.field public static xy:Z

.field public static yy:Z
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/am/v;->zy:Z

    const/4 v1, 0x1

    sput-boolean v1, Lcom/android/server/am/v;->Ay:Z

    sput-boolean v0, Lcom/android/server/am/v;->By:Z

    const-wide/16 v2, 0x0

    sput-wide v2, Lcom/android/server/am/v;->Cy:J

    const-string v4, ""

    sput-object v4, Lcom/android/server/am/v;->Dy:Ljava/lang/String;

    sput-object v4, Lcom/android/server/am/v;->Ey:Ljava/lang/String;

    new-instance v4, Ljava/util/HashMap;

    invoke-direct {v4}, Ljava/util/HashMap;-><init>()V

    sput-object v4, Lcom/android/server/am/v;->Gy:Ljava/util/HashMap;

    sput v0, Lcom/android/server/am/v;->Hy:I

    sput-wide v2, Lcom/android/server/am/v;->Iy:J

    sput-wide v2, Lcom/android/server/am/v;->Jy:J

    sput-boolean v1, Lcom/android/server/am/v;->Ky:Z

    sput-boolean v1, Lcom/android/server/am/v;->Ly:Z
    ...
    sput-wide v2, Lcom/android/server/am/v;->Ny:J

    const-wide/32 v4, 0x1b7740

    sput-wide v4, Lcom/android/server/am/v;->Oy:J

    sput-wide v4, Lcom/android/server/am/v;->Py:J

    const/16 v0, 0x1e

    sput v0, Lcom/android/server/am/v;->Qy:I
    ...
    sput-wide v2, Lcom/android/server/am/v;->Ty:J

    const/16 v0, 0x14

    sput v0, Lcom/android/server/am/v;->Uy:I

    const-wide/high16 v2, 0x4059000000000000L    # 100.0

    sput-wide v2, Lcom/android/server/am/v;->Vy:D

    const/4 v0, 0x3

    sput v0, Lcom/android/server/am/v;->Wy:I
    ...
    sput v1, Lcom/android/server/am/v;->Zy:I

    sput v0, Lcom/android/server/am/v;->_y:I

    const/16 v0, 0xa

    sput v0, Lcom/android/server/am/v;->az:I
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/am/v;->ay:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/am/v;->by:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Lcom/android/server/am/v;->hy:Ljava/util/ArrayList;
...
.method public constructor <init>(Ljava/io/File;)V
    ...
    sput-boolean v0, Lcom/android/server/am/v;->Ly:Z

    sget-boolean v0, Lcom/android/server/am/v;->Ly:Z
    ...
    sget-boolean v2, Lcom/android/server/am/v;->Ly:Z
    ...
    :cond_3
    sget-boolean p1, Lcom/android/server/am/v;->Ly:Z
    ...
    :cond_5
    :goto_0
    sput-object p0, Lcom/android/server/am/v;->Fy:Lcom/android/server/am/v;
...
.method private Ba(Z)Ljava/util/HashMap;
    ...
    :goto_1
    iget-object p0, p0, Lcom/android/server/am/v;->by:Ljava/util/HashMap;
    ...
    sput-wide v0, Lcom/android/server/am/v;->Iy:J
    ...
    sget-wide v2, Lcom/android/server/am/v;->Iy:J

    sub-long/2addr v0, v2

    sget-wide v2, Lcom/android/server/am/v;->Py:J
    ...
    sget-wide v0, Lcom/android/server/am/v;->Py:J
    ...
    iget-object v2, p0, Lcom/android/server/am/v;->by:Ljava/util/HashMap;

    invoke-virtual {v2}, Ljava/util/HashMap;->clear()V

    iget-object v2, p0, Lcom/android/server/am/v;->ay:Ljava/util/ArrayList;
    ...
    iget-object v5, v5, Lcom/android/server/am/v$you;->Ex:Ljava/util/ArrayList;
    ...
    :cond_5
    sget v3, Lcom/android/server/am/v;->Yy:I

    :goto_5
    sget v5, Lcom/android/server/am/v;->Yy:I

    sget v6, Lcom/android/server/am/v;->Xy:I
    ...
    :goto_6
    sget v5, Lcom/android/server/am/v;->Zy:I
    ...
    sget v5, Lcom/android/server/am/v;->az:I
    ...
    :cond_b
    sget v3, Lcom/android/server/am/v;->_y:I
    ...
    :cond_f
    iget-object p1, p0, Lcom/android/server/am/v;->by:Ljava/util/HashMap;
...
.method static synthetic Cb()J
    ...
    sget-wide v0, Lcom/android/server/am/v;->Ry:J
...
.method private On()V
    ...
    sget-object v0, Lcom/android/server/am/v;->Gy:Ljava/util/HashMap;
    ...
    sget-object v4, Lcom/android/server/am/v;->Gy:Ljava/util/HashMap;
    ...
    :goto_1
    sget v7, Lcom/android/server/am/v;->Zy:I
...
.method private Pn()V
    ...
    iget-wide v10, v9, Lcom/android/server/am/v$bio;->Sx:D

    add-double/2addr v5, v10

    iget-wide v9, v9, Lcom/android/server/am/v$bio;->Tx:D
    ...
    iput-wide v7, v0, Lcom/android/server/am/v$zta;->Dx:D
...
.method private Qn()V
    ...
    iget-object p0, p0, Lcom/android/server/am/v;->gy:Ljava/util/ArrayList;
...
.method private Sn()Ljava/util/ArrayList;
    ...
    iget-wide v7, v1, Lcom/android/server/am/v$zta;->Dx:D
...
.method private Tn()Z
    ...
    sget-boolean p0, Lcom/android/server/am/v;->By:Z
    ...
    sget-wide v2, Lcom/android/server/am/v;->Cy:J

    sub-long/2addr v0, v2

    sget-wide v2, Lcom/android/server/am/v;->Sy:J
    ...
    sput-boolean p0, Lcom/android/server/am/v;->By:Z
...
.method private Un()V
    ...
    :goto_0
    sget v1, Lcom/android/server/am/v;->Zy:I

    if-ge v0, v1, :cond_0

    iget-object v1, p0, Lcom/android/server/am/v;->dy:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Lcom/android/server/am/v;->dy:Ljava/util/ArrayList;
...
.method private Vn()V
    ...
    sput-boolean p0, Lcom/android/server/am/v;->yy:Z
...
.method private Wn()V
    ...
    sput-wide v0, Lcom/android/server/am/v;->Ny:J
    ...
    sput p0, Lcom/android/server/am/v;->Qy:I

    const-wide/32 v0, 0x493e0

    sput-wide v0, Lcom/android/server/am/v;->Sy:J
...
.method private Xn()V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/v;->by:Ljava/util/HashMap;
    ...
    iget-object v3, p0, Lcom/android/server/am/v;->by:Ljava/util/HashMap;
    ...
    iget-object v4, p0, Lcom/android/server/am/v;->by:Ljava/util/HashMap;
    ...
    :cond_d
    iget-object v4, p0, Lcom/android/server/am/v;->gy:Ljava/util/ArrayList;
...
.method static synthetic access$300()Z
    ...
    sget-boolean v0, Lcom/android/server/am/v;->By:Z
...
.method static synthetic access$3300()I
    ...
    sget v0, Lcom/android/server/am/v;->Hy:I
...
.method static synthetic access$3500()I
    ...
    sget v0, Lcom/android/server/am/v;->Qy:I
...
.method static synthetic access$400()J
    ...
    sget-wide v0, Lcom/android/server/am/v;->Cy:J
...
.method static synthetic bvj(J)J
    ...
    sput-wide p0, Lcom/android/server/am/v;->Jy:J
...
.method private calculate()V
    ...
    sget v3, Lcom/android/server/am/v;->Uy:I

    if-le v3, v2, :cond_4

    invoke-direct {p0}, Lcom/android/server/am/v;->Rn()V

    invoke-direct {p0}, Lcom/android/server/am/v;->Sn()Ljava/util/ArrayList;
    ...
    iget-object v4, v4, Lcom/android/server/am/v$you;->Fx:Lcom/android/server/am/v$zta;
    ...
    iput-wide v1, v0, Lcom/android/server/am/v$you;->Gx:D
...
.method public static getInstance()Lcom/android/server/am/v;
    ...
    sget-object v0, Lcom/android/server/am/v;->Fy:Lcom/android/server/am/v;
    ...
    sput-object v0, Lcom/android/server/am/v;->Fy:Lcom/android/server/am/v;
...
.method static synthetic ibl(J)J
    ...
    sput-wide p0, Lcom/android/server/am/v;->Cy:J
...
.method static synthetic o(I)I
    ...
    sput p0, Lcom/android/server/am/v;->Hy:I
...
.method public static resolveConfig(Lorg/json/JSONArray;)V
    ...
    sget-boolean v3, Lcom/android/server/am/v;->Ly:Z
    ...
    :cond_6
    :goto_1
    sput-boolean v2, Lcom/android/server/am/v;->Ly:Z
    ...
    :cond_8
    sget-boolean p0, Lcom/android/server/am/v;->Ly:Z
    ...
    sput-boolean p0, Lcom/android/server/am/v;->Ky:Z
...
.method private sis([Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/server/am/v;->hy:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lcom/android/server/am/v;->hy:Ljava/util/ArrayList;
    ...
    :cond_0
    sget-object p1, Lcom/android/server/am/v;->Gy:Ljava/util/HashMap;
...
.method private ssp([Ljava/lang/String;)V
    ...
    sget p1, Lcom/android/server/am/v;->Wy:I
    ...
    sput p1, Lcom/android/server/am/v;->Zy:I
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/server/am/v;->dy:Ljava/util/ArrayList;
...
.method static synthetic tc()J
    ...
    sget-wide v0, Lcom/android/server/am/v;->My:J
...
.method private static vdw(J)V
    ...
    sput-wide p0, Lcom/android/server/am/v;->Ny:J
...
.method private wtn(Ljava/util/ArrayList;)V
    ...
    sget-wide v8, Lcom/android/server/am/v;->Vy:D
    ...
    :cond_5
    sget-wide v12, Lcom/android/server/am/v;->Vy:D
...
.method static synthetic x(Ljava/lang/String;)Ljava/lang/String;
    ...
    sput-object p0, Lcom/android/server/am/v;->Dy:Ljava/lang/String;
...
.method private static you(Lcom/android/server/am/v$bio;Lcom/android/server/am/v$zta;)D
    ...
    iget-wide v0, p0, Lcom/android/server/am/v$bio;->Rx:D

    iget-wide v2, p0, Lcom/android/server/am/v$bio;->Sx:D

    iget-wide v4, p0, Lcom/android/server/am/v$bio;->Tx:D

    iget-wide v6, p1, Lcom/android/server/am/v$zta;->mX:D

    iget-wide v8, p1, Lcom/android/server/am/v$zta;->mY:D

    iget-wide v10, p1, Lcom/android/server/am/v$zta;->Dx:D
...
.method private you(Ljava/io/File;)V
    ...
    sget-boolean v5, Lcom/android/server/am/v;->By:Z
    ...
    sget-wide v5, Lcom/android/server/am/v;->Cy:J
    ...
    sput-boolean v1, Lcom/android/server/am/v;->By:Z
    ...
    sget-boolean v4, Lcom/android/server/am/v;->By:Z
    ...
    sput-wide v4, Lcom/android/server/am/v;->Cy:J
    ...
    sget-wide v4, Lcom/android/server/am/v;->Cy:J
    ...
    :goto_2
    sget-object v1, Lcom/android/server/am/v;->Gy:Ljava/util/HashMap;
...
.method private static zta(Lcom/android/server/am/v$zta;Lcom/android/server/am/v$zta;)D
    ...
    iget-wide v4, p0, Lcom/android/server/am/v$zta;->Dx:D
...
.method public a(Z)V
    ...
    sget-boolean p1, Lcom/android/server/am/v;->Ay:Z

    if-nez p1, :cond_1

    sget-wide v3, Lcom/android/server/am/v;->Jy:J

    sub-long v3, v0, v3

    sget-wide v5, Lcom/android/server/am/v;->Oy:J
    ...
    sput-boolean p1, Lcom/android/server/am/v;->Ay:Z
...
.method public doCleanData(J)V
    ...
    sget-object v2, Lcom/android/server/am/v;->Gy:Ljava/util/HashMap;
    ...
    sput-wide p1, Lcom/android/server/am/v;->Cy:J
    ...
    sput-wide p1, Lcom/android/server/am/v;->Jy:J

    iget-object p1, p0, Lcom/android/server/am/v;->ay:Ljava/util/ArrayList;
...
.method public getInitPackagesFromSystemReady()Z
    ...
    sget-boolean p0, Lcom/android/server/am/v;->xy:Z
...
.method public gwm(J)V
    ...
    sget-boolean v0, Lcom/android/server/am/v;->xy:Z
    ...
    sget-wide v6, Lcom/android/server/am/v;->Ty:J
...
.method public initEssentials()V
    ...
    sput-wide v0, Lcom/android/server/am/v;->Cy:J
...
.method public ivd(Z)Ljava/util/ArrayList;
    ...
    invoke-direct {p0}, Lcom/android/server/am/v;->Tn()Z
...
.method public rankAllPkgs()V
    ...
    :try_start_1
    iget-object v4, v1, Lcom/android/server/am/v;->ay:Ljava/util/ArrayList;
    ...
    :cond_2
    sget-object v6, Lcom/android/server/am/v;->Gy:Ljava/util/HashMap;
    ...
    sget-object v11, Lcom/android/server/am/v;->Gy:Ljava/util/HashMap;
    ...
    sget-object v9, Lcom/android/server/am/v;->Gy:Ljava/util/HashMap;
    ...
    :goto_2
    sget v6, Lcom/android/server/am/v;->Hy:I
    ...
    :cond_7
    sget v9, Lcom/android/server/am/v;->Hy:I
    ...
    sget v8, Lcom/android/server/am/v;->Hy:I
    ...
    iget-wide v11, v5, Lcom/android/server/am/v$bio;->Tx:D
    ...
    iput-wide v11, v5, Lcom/android/server/am/v$bio;->Tx:D
    ...
    iget-wide v6, v5, Lcom/android/server/am/v$bio;->Tx:D
    ...
    iget-object v6, v1, Lcom/android/server/am/v;->ay:Ljava/util/ArrayList;
    ...
    :goto_9
    sget v2, Lcom/android/server/am/v;->Zy:I

    if-ge v0, v2, :cond_11

    iget-object v2, v1, Lcom/android/server/am/v;->dy:Ljava/util/ArrayList;
    ...
    sget v9, Lcom/android/server/am/v;->Zy:I
    ...
    sget v11, Lcom/android/server/am/v;->Zy:I
    ...
    iput-wide v11, v2, Lcom/android/server/am/v$zta;->Dx:D
...
.method public removePackage(Ljava/lang/String;)V
    ...
    :try_start_0
    sget-object v0, Lcom/android/server/am/v;->Ey:Ljava/lang/String;
...
.method public setInitPackagesFromSystemReady(Z)V
    ...
    sput-boolean p1, Lcom/android/server/am/v;->xy:Z
...
.method public setUpdatingPackage(Ljava/lang/String;)V
    ...
    sput-object p1, Lcom/android/server/am/v;->Ey:Ljava/lang/String;
...
.method public you(Landroid/content/Context;Ljava/lang/String;J)V
    ...
    sput-object p2, Lcom/android/server/am/v;->Dy:Ljava/lang/String;
    ...
    sget-object p3, Lcom/android/server/am/v;->Dy:Ljava/lang/String;
    ...
    sget-object p1, Lcom/android/server/am/v;->Dy:Ljava/lang/String;
...
.method public zta(Landroid/content/Context;Ljava/lang/String;J)V
    ...
    sget-boolean v1, Lcom/android/server/am/v;->zy:Z
...
.method public zta(Ljava/io/PrintWriter;Ljava/util/ArrayList;Z)V
    ...
    iget-object p2, p0, Lcom/android/server/am/v;->gy:Ljava/util/ArrayList;
    ...
    iget-object p2, p0, Lcom/android/server/am/v;->ay:Ljava/util/ArrayList;
    ...
    iget-wide v5, p3, Lcom/android/server/am/v$bio;->Sx:D
    ...
    iget-wide v4, p3, Lcom/android/server/am/v$bio;->Tx:D
