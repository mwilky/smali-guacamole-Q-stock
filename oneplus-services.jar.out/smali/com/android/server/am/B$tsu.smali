...
.method synthetic constructor <init>(Lcom/android/server/am/B;Lcom/android/server/am/x;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/am/B$tsu;-><init>(Lcom/android/server/am/B;)V
...
.method public run()V
    ...
    iget-object v7, p0, Lcom/android/server/am/B$tsu;->this$0:Lcom/android/server/am/B;

    invoke-static {v7}, Lcom/android/server/am/B;->kth(Lcom/android/server/am/B;)Lcom/android/server/am/dma;
    ...
    invoke-virtual {v7, v6, v0}, Lcom/android/server/am/B;->tsu(Ljava/lang/String;I)Lcom/android/server/am/bvj;
    ...
    iget-object v6, p0, Lcom/android/server/am/B$tsu;->this$0:Lcom/android/server/am/B;

    invoke-static {v6}, Lcom/android/server/am/B;->kth(Lcom/android/server/am/B;)Lcom/android/server/am/dma;
    ...
    invoke-virtual {v7}, Lcom/android/server/am/bvj;->Ma()Z
    ...
    invoke-virtual {v6, v7, v5, v4}, Lcom/android/server/am/B;->zta(Lcom/android/server/am/bvj;IZ)V
    :try_end_0
