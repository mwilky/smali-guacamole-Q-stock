...
.method constructor <init>(Lcom/android/server/am/z;)V
    ...
    iput-object p1, p0, Lcom/android/server/am/x;->this$0:Lcom/android/server/am/z;
...
.method public run()V
    ...
    iget-object v1, p0, Lcom/android/server/am/x;->this$0:Lcom/android/server/am/z;

    invoke-static {v1}, Lcom/android/server/am/z;->ssp(Lcom/android/server/am/z;)Ljava/util/List;
    ...
    iget-object v4, p0, Lcom/android/server/am/x;->this$0:Lcom/android/server/am/z;

    invoke-static {v4}, Lcom/android/server/am/z;->ssp(Lcom/android/server/am/z;)Ljava/util/List;
    ...
    iget-object v2, p0, Lcom/android/server/am/x;->this$0:Lcom/android/server/am/z;

    invoke-static {v2}, Lcom/android/server/am/z;->ssp(Lcom/android/server/am/z;)Ljava/util/List;
    ...
    invoke-static {v1}, Lcom/android/server/am/z;->cno(Lcom/android/server/am/z;)Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/android/server/am/x;->this$0:Lcom/android/server/am/z;

    invoke-static {v6}, Lcom/android/server/am/z;->cno(Lcom/android/server/am/z;)Ljava/util/List;
    ...
    iget-object v3, p0, Lcom/android/server/am/x;->this$0:Lcom/android/server/am/z;

    invoke-static {v3}, Lcom/android/server/am/z;->ssp(Lcom/android/server/am/z;)Ljava/util/List;
