...
.field private static final Kx:Ljava/lang/String; = "/data/system/embryo_black"

.field private static final Lx:I = 0x3

.field private static final Mx:Ljava/lang/String; = "embryo_crash"

.field private static Nx:Ljava/util/ArrayList; = null
...
.field private final Fx:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/String;",
...
.field private final Jx:Ljava/lang/Runnable;
...
.field private yx:Lcom/android/server/am/bvj;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/am/x;->Nx:Ljava/util/ArrayList;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/am/x;->zx:Ljava/util/List;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/am/x;->Ax:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/am/x;->Bx:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/am/x;->Cx:Ljava/util/Map;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/am/x;->Dx:Ljava/util/List;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/am/x;->Ex:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/am/x;->Fx:Ljava/util/Map;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lcom/android/server/am/x;->Hx:Ljava/lang/Object;

    new-instance v0, Lcom/android/server/am/v;

    invoke-direct {v0, p0}, Lcom/android/server/am/v;-><init>(Lcom/android/server/am/x;)V

    iput-object v0, p0, Lcom/android/server/am/x;->Ix:Ljava/lang/Runnable;

    new-instance v0, Lcom/android/server/am/w;

    invoke-direct {v0, p0}, Lcom/android/server/am/w;-><init>(Lcom/android/server/am/x;)V

    iput-object v0, p0, Lcom/android/server/am/x;->Jx:Ljava/lang/Runnable;
...
.method static synthetic access$1000()Ljava/util/ArrayList;
    ...
    sget-object v0, Lcom/android/server/am/x;->Nx:Ljava/util/ArrayList;
...
.method private bio(Ljava/util/Set;)V
    ...
    iget-object v1, p0, Lcom/android/server/am/x;->Ax:Ljava/util/Map;
    ...
    iget-object v3, p0, Lcom/android/server/am/x;->Ax:Ljava/util/Map;
...
.method static synthetic cno(Lcom/android/server/am/x;)Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/android/server/am/x;->zx:Ljava/util/List;
...
.method static synthetic sis(Lcom/android/server/am/x;)V
    ...
    invoke-direct {p0}, Lcom/android/server/am/x;->yn()V
...
.method static synthetic ssp(Lcom/android/server/am/x;)Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/android/server/am/x;->Dx:Ljava/util/List;
...
.method private declared-synchronized yn()V
    ...
    :try_start_1
    iget-object v2, p0, Lcom/android/server/am/x;->Ax:Ljava/util/Map;
    ...
    iget-object v9, p0, Lcom/android/server/am/x;->Gx:Ljava/lang/String;
...
.method static synthetic you(Lcom/android/server/am/x;)Ljava/util/Map;
    ...
    iget-object p0, p0, Lcom/android/server/am/x;->Cx:Ljava/util/Map;
...
.method private declared-synchronized zn()V
    ...
    :cond_1
    sget-object v1, Lcom/android/server/am/x;->Nx:Ljava/util/ArrayList;
...
.method static synthetic zta(Lcom/android/server/am/x;)Ljava/util/Map;
    ...
    iget-object p0, p0, Lcom/android/server/am/x;->Bx:Ljava/util/Map;
...
.method public attach(Landroid/app/IApplicationThread;I)Z
    ...
    iget-object v0, p0, Lcom/android/server/am/x;->Bx:Ljava/util/Map;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/x;->Bx:Ljava/util/Map;
    ...
    iget-object v5, p0, Lcom/android/server/am/x;->Cx:Ljava/util/Map;
    ...
    :try_start_3
    iget-object v6, p0, Lcom/android/server/am/x;->Cx:Ljava/util/Map;
...
.method public cleanup()V
    ...
    iget-object v0, p0, Lcom/android/server/am/x;->Dx:Ljava/util/List;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/x;->Dx:Ljava/util/List;
    ...
    :try_start_1
    iget-object v0, p0, Lcom/android/server/am/x;->Ax:Ljava/util/Map;
    ...
    iget-object v1, p0, Lcom/android/server/am/x;->zx:Ljava/util/List;
...
.method public goingToSleep()V
    ...
    iget-object v0, p0, Lcom/android/server/am/x;->Hx:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/x;->yx:Lcom/android/server/am/bvj;
    ...
    iput-object v1, p0, Lcom/android/server/am/x;->yx:Lcom/android/server/am/bvj;
...
.method public killEmbryoProcesses(Z)V
    ...
    iget-object p0, p0, Lcom/android/server/am/x;->Ax:Ljava/util/Map;
...
.method public notifyApplicationCrash(Ljava/lang/String;IILjava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/server/am/x;->Ex:Ljava/util/Map;
    ...
    iget-object p2, p0, Lcom/android/server/am/x;->Fx:Ljava/util/Map;
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/server/am/x;->Fx:Ljava/util/Map;
...
.method public ssp(Ljava/io/PrintWriter;)V
    ...
    iget-object v2, p0, Lcom/android/server/am/x;->Bx:Ljava/util/Map;
    ...
    iget-object v1, p0, Lcom/android/server/am/x;->Cx:Ljava/util/Map;
    ...
    iget-object v2, p0, Lcom/android/server/am/x;->Cx:Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/android/server/am/x;->Cx:Ljava/util/Map;
    ...
    iget-object v2, p0, Lcom/android/server/am/x;->Dx:Ljava/util/List;
    ...
    iget-object v3, p0, Lcom/android/server/am/x;->Dx:Ljava/util/List;
    ...
    iget-wide v1, v0, Lcom/android/server/am/x$you;->xx:J
...
.method public trim()V
    ...
    iget-object v1, p0, Lcom/android/server/am/x;->Ix:Ljava/lang/Runnable;

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    iget-object v0, p0, Lcom/android/server/am/x;->mHandler:Landroid/os/Handler;

    iget-object p0, p0, Lcom/android/server/am/x;->Ix:Ljava/lang/Runnable;
...
.method public updateConfig()V
    ...
    iget-object v1, p0, Lcom/android/server/am/x;->Jx:Ljava/lang/Runnable;

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    iget-object v0, p0, Lcom/android/server/am/x;->mHandler:Landroid/os/Handler;

    iget-object p0, p0, Lcom/android/server/am/x;->Jx:Ljava/lang/Runnable;
...
.method public zta(Ljava/lang/String;II)V
    ...
    iget-object p0, p0, Lcom/android/server/am/x;->Ex:Ljava/util/Map;
...
.method public zta(Ljava/lang/String;ZI)V
    ...
    iput-object p1, p0, Lcom/android/server/am/x;->Gx:Ljava/lang/String;
    ...
    iget-object p2, p0, Lcom/android/server/am/x;->Hx:Ljava/lang/Object;

    monitor-enter p2

    :try_start_0
    iget-object p3, p0, Lcom/android/server/am/x;->yx:Lcom/android/server/am/bvj;
    ...
    iput-object p1, p0, Lcom/android/server/am/x;->yx:Lcom/android/server/am/bvj;
    ...
    :try_start_2
    iget-object p1, p0, Lcom/android/server/am/x;->zx:Ljava/util/List;
    ...
    :try_start_3
    iget-object p3, p0, Lcom/android/server/am/x;->zx:Ljava/util/List;

    iget-object v0, p0, Lcom/android/server/am/x;->yx:Lcom/android/server/am/bvj;

    invoke-interface {p3, v0}, Ljava/util/List;->remove(Ljava/lang/Object;)Z

    iget-object p3, p0, Lcom/android/server/am/x;->zx:Ljava/util/List;

    iget-object p0, p0, Lcom/android/server/am/x;->yx:Lcom/android/server/am/bvj;
