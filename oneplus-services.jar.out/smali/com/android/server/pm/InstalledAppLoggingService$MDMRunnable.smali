...
# static fields
.field private static final eE:Ljava/lang/String; = "7554P2RV0X"
...
.method private finishJob(Z)V
    ...
    iget-object v0, p0, Lcom/android/server/pm/InstalledAppLoggingService$MDMRunnable;->mJobService:Landroid/app/job/JobService;

    if-eqz v0, :cond_0

    iget-object p0, p0, Lcom/android/server/pm/InstalledAppLoggingService$MDMRunnable;->mParams:Landroid/app/job/JobParameters;
...
.method private jo()Ljava/util/List;
    .locals 2
...
.method public run()V
    ...
    invoke-static {}, Lcom/android/server/pm/InstalledAppLoggingService;->access$200()Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-static {}, Lcom/android/server/pm/InstalledAppLoggingService;->access$300()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/server/pm/InstalledAppLoggingService$MDMRunnable;->mContext:Landroid/content/Context;
    ...
    :try_start_0
    invoke-direct {p0}, Lcom/android/server/pm/InstalledAppLoggingService$MDMRunnable;->jo()Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/android/server/pm/InstalledAppLoggingService$MDMRunnable;->mContext:Landroid/content/Context;
    ...
    invoke-direct {p0, v7}, Lcom/android/server/pm/InstalledAppLoggingService$MDMRunnable;->finishJob(Z)V
...
.method public setContext(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/android/server/pm/InstalledAppLoggingService$MDMRunnable;->mContext:Landroid/content/Context;
...
.method public setJobService(Landroid/app/job/JobService;Landroid/app/job/JobParameters;)V
    ...
    iput-object p1, p0, Lcom/android/server/pm/InstalledAppLoggingService$MDMRunnable;->mJobService:Landroid/app/job/JobService;

    iput-object p2, p0, Lcom/android/server/pm/InstalledAppLoggingService$MDMRunnable;->mParams:Landroid/app/job/JobParameters;
