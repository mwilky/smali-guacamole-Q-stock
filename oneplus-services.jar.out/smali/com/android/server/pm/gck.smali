.class public Lcom/android/server/pm/gck;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/pm/gck$zta;
    }
.end annotation
...
.field private static final kF:Ljava/util/Set;
...
# instance fields
.field private final iF:Ljava/io/File;

.field private jF:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/pm/gck;->kF:Ljava/util/Set;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/pm/gck;->iF:Ljava/io/File;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/pm/gck;->jF:Ljava/util/ArrayList;
...
.method private cc(Ljava/lang/String;)I
    ...
    iget-object p0, p0, Lcom/android/server/pm/gck;->jF:Ljava/util/ArrayList;
    ...
    check-cast v0, Lcom/android/server/pm/gck$zta;

    if-eqz v0, :cond_0

    iget-object v1, v0, Lcom/android/server/pm/gck$zta;->packageName:Ljava/lang/String;
    ...
    iget p0, v0, Lcom/android/server/pm/gck$zta;->versionCode:I
...
.method private dc(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/server/pm/gck;->jF:Ljava/util/ArrayList;
    ...
    check-cast v1, Lcom/android/server/pm/gck$zta;

    if-eqz v1, :cond_0

    iget-object v2, v1, Lcom/android/server/pm/gck$zta;->packageName:Ljava/lang/String;
...
.method private ibl(Ljava/lang/String;I)V
    ...
    iput p2, v1, Lcom/android/server/pm/gck$zta;->versionCode:I
    ...
    new-instance v0, Lcom/android/server/pm/gck$zta;

    invoke-direct {v0, p1, p2}, Lcom/android/server/pm/gck$zta;-><init>(Ljava/lang/String;I)V
...
.method private oo()V
    ...
    :cond_6
    :goto_2
    iget-object v7, p0, Lcom/android/server/pm/gck;->jF:Ljava/util/ArrayList;

    new-instance v9, Lcom/android/server/pm/gck$zta;

    invoke-direct {v9, v6, v8}, Lcom/android/server/pm/gck$zta;-><init>(Ljava/lang/String;I)V
...
.method private po()V
    ...
    iget-object v6, p0, Lcom/android/server/pm/gck;->jF:Ljava/util/ArrayList;
    ...
    iget-object v10, p0, Lcom/android/server/pm/gck;->jF:Ljava/util/ArrayList;

    invoke-virtual {v10, v7}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v10

    check-cast v10, Lcom/android/server/pm/gck$zta;

    iget-object v10, v10, Lcom/android/server/pm/gck$zta;->packageName:Ljava/lang/String;
    ...
    iget v10, v10, Lcom/android/server/pm/gck$zta;->versionCode:I
...
.method public addForInitLI(Lcom/android/server/pm/PackageManagerService;Landroid/content/pm/PackageParser$Package;Lcom/android/server/pm/PackageSetting;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;JZ)Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/pm/gck;->isReserveApp(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/pm/gck;->checkAppHasDeleted(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v0}, Lcom/android/server/pm/gck;->cc(Ljava/lang/String;)I
    ...
    sget-object v0, Lcom/android/server/pm/gck;->kF:Ljava/util/Set;
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/server/pm/gck;->ibl(Ljava/lang/String;I)V

    invoke-direct {p0}, Lcom/android/server/pm/gck;->po()V
    ...
    invoke-direct {p0, p9}, Lcom/android/server/pm/gck;->cc(Ljava/lang/String;)I
    ...
    iget-object p4, p0, Lcom/android/server/pm/gck;->mPmsInner:Lcom/android/server/pm/PackageManagerService$PmsInner;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/pm/gck;->dc(Ljava/lang/String;)V
...
.method public checkAppHasDeleted(Ljava/lang/String;)Z
    ...
    iget-object v0, v0, Lcom/android/server/pm/gck$zta;->packageName:Ljava/lang/String;
...
.method public cleanUp(Ljava/io/File;)Z
    ...
    iget-object p0, p0, Lcom/android/server/pm/gck;->iF:Ljava/io/File;
...
.method public cleanUpResourcesLI(Ljava/io/File;Landroid/content/pm/PackageParser$PackageLite;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/pm/gck;->isReserveApp(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/pm/gck;->ibl(Ljava/lang/String;I)V
...
.method public collectReserveApps(I)V
    ...
    iget-object v0, p0, Lcom/android/server/pm/gck;->mPmsInner:Lcom/android/server/pm/PackageManagerService$PmsInner;
    ...
    iget-object v3, p0, Lcom/android/server/pm/gck;->mPmsInner:Lcom/android/server/pm/PackageManagerService$PmsInner;
...
.method public initInstance(Lcom/android/server/pm/PackageManagerService$PmsInner;)V
    ...
    iput-object p1, p0, Lcom/android/server/pm/gck;->mPmsInner:Lcom/android/server/pm/PackageManagerService$PmsInner;

    invoke-direct {p0}, Lcom/android/server/pm/gck;->oo()V
