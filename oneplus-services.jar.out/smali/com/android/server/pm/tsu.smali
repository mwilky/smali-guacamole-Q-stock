...
.field public static final DE:I = 0x5f

.field private static final DEBUG:Z

.field public static final EE:I = 0x1bb

.field public static final GE:I = 0x1bc

.field public static final GPU_OUT_OF_MEMORY:I = 0xa8

.field public static final JE:I = 0x1bd

.field public static final KE:I = 0x6f

.field public static final LE:I = 0x55

.field public static final ME:I = 0x68

.field public static final NE:I = 0x4e

.field public static final OE:I = 0xd3

.field public static final QE:I = 0x47

.field public static final RE:I = 0x46

.field public static final SE:I = 0xf

.field private static final TAG:Ljava/lang/String; = "OpCompatibilityHelper"

.field public static final TE:I = 0x1e8

.field public static final UE:I = 0xe6

.field public static final VE:I = 0x50

.field public static final WE:I = 0x2

.field public static final XE:I = 0x1d7

.field public static final YE:I = 0x1e6

.field private static final ZD:Ljava/lang/String; = "compatibility_config_values"

.field public static final ZE:I = 0x14c

.field private static final _D:Ljava/lang/String; = "/data/system/oneplus_cpt_list.xml"

.field public static final _E:I = 0x166

.field private static final aE:Ljava/lang/String; = "/system/etc/oneplus_cpt_list.xml"

.field public static final aF:I = 0x186

.field public static final bF:I = 0xd1

.field public static final cF:I = 0xd0

.field private static final dF:Ljava/util/Map;
...
.field private static final tE:Ljava/lang/String; = "/data/system/install_warning_list.xml"

.field private static final uE:Ljava/lang/String; = "/system/etc/install_warning_list.xml"

.field private static final vE:Ljava/lang/String; = "CompatConfigList"

.field private static final wE:Ljava/lang/String; = "disable.install.warning"

.field public static final xE:I = 0x0

.field public static final yE:I = 0x1

.field public static final zE:I = 0x14b


# instance fields
.field private qE:Landroid/util/SparseArray;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/pm/tsu;->DEBUG:Z

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/android/server/pm/tsu;->sConfigLock:Ljava/lang/Object;

    sput v1, Lcom/android/server/pm/tsu;->mTotalCount:I

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lcom/android/server/pm/tsu;->dF:Ljava/util/Map;

    sget-object v0, Lcom/android/server/pm/tsu;->dF:Ljava/util/Map;
    ...
    sput-object v0, Lcom/android/server/pm/tsu;->eF:Ljava/util/Map;

    sget-object v0, Lcom/android/server/pm/tsu;->eF:Ljava/util/Map;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/pm/tsu;->qE:Landroid/util/SparseArray;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/pm/tsu;->rE:Ljava/util/Map;
...
.method private Zb(Ljava/lang/String;)Z
    ...
    iget-object p1, p0, Lcom/android/server/pm/tsu;->rE:Ljava/util/Map;
    ...
    iget-object p0, p0, Lcom/android/server/pm/tsu;->rE:Ljava/util/Map;
    ...
    :cond_3
    iget-object v3, p0, Lcom/android/server/pm/tsu;->rE:Ljava/util/Map;
    ...
    iget-object v4, p0, Lcom/android/server/pm/tsu;->rE:Ljava/util/Map;
...
.method private _b(Ljava/lang/String;)V
    ...
    iget-object v6, p0, Lcom/android/server/pm/tsu;->rE:Ljava/util/Map;
...
.method private igw(Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, v10}, Lcom/android/server/pm/tsu;->cno([C)I
    ...
    invoke-direct {p0, v9}, Lcom/android/server/pm/tsu;->ac(Ljava/lang/String;)Z

    move-result v10

    if-eqz v10, :cond_5

    invoke-direct {p0, v9}, Lcom/android/server/pm/tsu;->bc(Ljava/lang/String;)Z
    ...
    :cond_8
    sget p1, Lcom/android/server/pm/tsu;->mTotalCount:I
    ...
    sget-boolean v1, Lcom/android/server/pm/tsu;->DEBUG:Z
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/pm/tsu;->zta(Ljava/lang/String;Landroid/util/SparseArray;)V

    sget-object p1, Lcom/android/server/pm/tsu;->sConfigLock:Ljava/lang/Object;
    ...
    sput v4, Lcom/android/server/pm/tsu;->mTotalCount:I
    ...
    invoke-direct {p0}, Lcom/android/server/pm/tsu;->no()V
    :try_end_2
...
.method private lo()V
    ...
    :goto_0
    invoke-direct {p0, v0}, Lcom/android/server/pm/tsu;->readFromFile(Ljava/io/File;)Ljava/lang/String;
    ...
    :cond_2
    sget-object v3, Lcom/android/server/pm/tsu;->sConfigLock:Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v5, p0, Lcom/android/server/pm/tsu;->qE:Landroid/util/SparseArray;
    ...
    :cond_4
    invoke-direct {p0, v0}, Lcom/android/server/pm/tsu;->cno([C)I
    ...
    :cond_5
    iget-object v4, p0, Lcom/android/server/pm/tsu;->qE:Landroid/util/SparseArray;
    ...
    iget-object v7, p0, Lcom/android/server/pm/tsu;->qE:Landroid/util/SparseArray;
    ...
    :goto_2
    sget v0, Lcom/android/server/pm/tsu;->mTotalCount:I

    add-int/2addr v0, v2

    sput v0, Lcom/android/server/pm/tsu;->mTotalCount:I
    ...
    sget-object v0, Lcom/android/server/pm/tsu;->sConfigLock:Ljava/lang/Object;
    ...
    iget-object v2, p0, Lcom/android/server/pm/tsu;->qE:Landroid/util/SparseArray;

    invoke-direct {p0, v1, v2}, Lcom/android/server/pm/tsu;->zta(Ljava/lang/String;Landroid/util/SparseArray;)V
...
.method private mo()V
    ...
    iget-object v0, p0, Lcom/android/server/pm/tsu;->rE:Ljava/util/Map;
    ...
    invoke-direct {p0, v0}, Lcom/android/server/pm/tsu;->_b(Ljava/lang/String;)V
...
.method private sis(Landroid/content/pm/PackageParser$Package;)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/server/pm/tsu;->zta(Ljava/util/ArrayList;Z)V
...
.method private you(Landroid/content/pm/PackageParser$Package;)V
    ...
    :goto_0
    invoke-direct {p0, v0, p1, v1}, Lcom/android/server/pm/tsu;->zta(Ljava/util/ArrayList;Ljava/lang/String;Z)V
...
.method static synthetic zta(Lcom/android/server/pm/tsu;Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/pm/tsu;->igw(Lorg/json/JSONArray;)V
...
.method private zta(Ljava/lang/String;Landroid/util/SparseArray;)V
    ...
    invoke-direct {p0, v9}, Lcom/android/server/pm/tsu;->Fb(I)Ljava/lang/String;
...
.method public O(Ljava/lang/String;)I
    ...
    sget-object p0, Lcom/android/server/pm/tsu;->dF:Ljava/util/Map;
...
.method public customizePackageIfNeeded(Landroid/content/pm/PackageParser$Package;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/pm/tsu;->sis(Landroid/content/pm/PackageParser$Package;)V

    invoke-direct {p0, p1}, Lcom/android/server/pm/tsu;->you(Landroid/content/pm/PackageParser$Package;)V

    invoke-direct {p0, p1}, Lcom/android/server/pm/tsu;->rtg(Landroid/content/pm/PackageParser$Package;)V

    invoke-direct {p0, p1}, Lcom/android/server/pm/tsu;->tsu(Landroid/content/pm/PackageParser$Package;)V
    :try_end_0
...
.method public dumpToString()Ljava/lang/String;
    ...
    sget-object v1, Lcom/android/server/pm/tsu;->sConfigLock:Ljava/lang/Object;
    ...
    :try_start_1
    iget-object v1, p0, Lcom/android/server/pm/tsu;->rE:Ljava/util/Map;
...
.method public getCompatConfigString(ILjava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/server/pm/tsu;->qE:Landroid/util/SparseArray;
...
.method public initCompatOnlineConfig()V
    ...
    sget-object v1, Lcom/android/server/pm/tsu;->mContext:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/android/server/pm/tsu;->sE:Lcom/oneplus/config/ConfigObserver;

    iget-object p0, p0, Lcom/android/server/pm/tsu;->sE:Lcom/oneplus/config/ConfigObserver;
...
.method public initInstance(Landroid/content/Context;)V
    ...
    sput-object p1, Lcom/android/server/pm/tsu;->mContext:Landroid/content/Context;

    invoke-direct {p0}, Lcom/android/server/pm/tsu;->lo()V
    ...
    invoke-direct {p0}, Lcom/android/server/pm/tsu;->mo()V

    :cond_0
    sget-boolean p1, Lcom/android/server/pm/tsu;->DEBUG:Z
...
.method public isInConfigList(ILjava/lang/String;)Z
    ...
    invoke-direct {p0, p2}, Lcom/android/server/pm/tsu;->Zb(Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/pm/tsu;->qE:Landroid/util/SparseArray;
...
.method public u(I)Ljava/lang/String;
    ...
    sget-object p0, Lcom/android/server/pm/tsu;->eF:Ljava/util/Map;
