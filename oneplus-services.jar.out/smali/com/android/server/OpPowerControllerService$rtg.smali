...
# static fields
.field private static final ff:Ljava/lang/String; = "idle-records.xml"
...
.field private cf:Ljava/time/LocalTime;

.field private df:Ljava/time/Duration;

.field private ef:Ljava/time/LocalDateTime;
...
.method public constructor <init>(Lcom/android/server/OpPowerControllerService;)V
    ...
    iput-object p1, p0, Lcom/android/server/OpPowerControllerService$rtg;->bf:Ljava/util/ArrayList;
...
.method private you(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iget-object v9, v1, Lcom/android/server/OpPowerControllerService$rtg;->bf:Ljava/util/ArrayList;
...
.method private zta(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    iget-object v0, p0, Lcom/android/server/OpPowerControllerService$rtg;->bf:Ljava/util/ArrayList;
    ...
    :goto_0
    :try_start_0
    iget-object v3, p0, Lcom/android/server/OpPowerControllerService$rtg;->bf:Ljava/util/ArrayList;
...
.method public K()[[D
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/OpPowerControllerService$rtg;->bf:Ljava/util/ArrayList;
    ...
    :goto_0
    iget-object v4, p0, Lcom/android/server/OpPowerControllerService$rtg;->bf:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, Lcom/android/server/OpPowerControllerService$rtg;->bf:Ljava/util/ArrayList;
...
.method public L()Ljava/time/Duration;
    ...
    iget-object p0, p0, Lcom/android/server/OpPowerControllerService$rtg;->df:Ljava/time/Duration;
...
.method public M()Ljava/time/LocalTime;
    ...
    iget-object p0, p0, Lcom/android/server/OpPowerControllerService$rtg;->cf:Ljava/time/LocalTime;
...
.method public N()Ljava/time/LocalDateTime;
    ...
    iget-object p0, p0, Lcom/android/server/OpPowerControllerService$rtg;->ef:Ljava/time/LocalDateTime;
...
.method public P()Ljava/time/LocalDateTime;
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/OpPowerControllerService$rtg;->cf:Ljava/time/LocalTime;
...
.method public R()V
    ...
    iput-object v0, p0, Lcom/android/server/OpPowerControllerService$rtg;->cf:Ljava/time/LocalTime;

    iput-object v0, p0, Lcom/android/server/OpPowerControllerService$rtg;->df:Ljava/time/Duration;

    iput-object v0, p0, Lcom/android/server/OpPowerControllerService$rtg;->ef:Ljava/time/LocalDateTime;
...
.method public S()V
    ...
    :try_start_6
    iget-object p0, p0, Lcom/android/server/OpPowerControllerService$rtg;->bf:Ljava/util/ArrayList;
...
.method public sis(Ljava/time/LocalDateTime;)V
    ...
    iput-object p1, p0, Lcom/android/server/OpPowerControllerService$rtg;->ef:Ljava/time/LocalDateTime;
...
.method you(Ljava/time/Duration;)V
    ...
    iput-object p1, p0, Lcom/android/server/OpPowerControllerService$rtg;->df:Ljava/time/Duration;
...
.method public zta(Ljava/time/LocalDateTime;Ljava/time/LocalDateTime;)V
    ...
    iget-object p1, p0, Lcom/android/server/OpPowerControllerService$rtg;->bf:Ljava/util/ArrayList;

    monitor-enter p1

    :try_start_0
    iget-object p2, p0, Lcom/android/server/OpPowerControllerService$rtg;->bf:Ljava/util/ArrayList;
...
.method zta(Ljava/time/LocalTime;)V
    ...
    iput-object p1, p0, Lcom/android/server/OpPowerControllerService$rtg;->cf:Ljava/time/LocalTime;
