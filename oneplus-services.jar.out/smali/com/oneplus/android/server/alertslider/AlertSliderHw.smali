...
# static fields
.field private static final AY:Ljava/lang/String; = "/mnt/vendor/persist/engineermode/tri_state_hall_data"

.field private static final DEBUG:Z

.field public static final Naa:I = 0x2

.field public static final Oaa:I = 0x3

.field public static final Paa:I = -0x1

.field public static final SWITCH_STATE_ON:I = 0x1

.field private static final TAG:Ljava/lang/String; = "AlertSliderHw"

.field private static final Vaa:Ljava/lang/String; = "/sys/bus/platform/devices/soc:tri_state_key/hall_data_calib"

.field private static final Waa:Ljava/lang/String; = "tri-state-key"

.field private static final Xaa:Ljava/lang/String; = "soc:tri_state_key"

.field private static final Yaa:I = 0x1

.field private static final Zaa:I = 0x2

.field private static final _aa:I = 0x4


# instance fields
.field private Raa:Lcom/oneplus/android/server/alertslider/AlertSliderHw$you;

.field private Saa:Lcom/oneplus/android/server/alertslider/AlertSliderHw$zta;

.field private Taa:Lcom/oneplus/android/server/alertslider/zta;

.field private Uaa:Landroid/os/PowerManager$WakeLock;
...
.method public constructor <init>(Landroid/content/Context;Lcom/oneplus/android/server/alertslider/zta;)V
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->Raa:Lcom/oneplus/android/server/alertslider/AlertSliderHw$you;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->Saa:Lcom/oneplus/android/server/alertslider/AlertSliderHw$zta;

    iput-object p1, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->mContext:Landroid/content/Context;

    iput-object p2, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->Taa:Lcom/oneplus/android/server/alertslider/zta;
    ...
    iput-object p1, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->Uaa:Landroid/os/PowerManager$WakeLock;
...
.method private ec(I)V
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->Taa:Lcom/oneplus/android/server/alertslider/zta;

    if-eqz p0, :cond_0

    invoke-virtual {p0, p1}, Lcom/oneplus/android/server/alertslider/sis;->F(I)V
...
.method static synthetic you(Lcom/oneplus/android/server/alertslider/AlertSliderHw;)Landroid/os/PowerManager$WakeLock;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->Uaa:Landroid/os/PowerManager$WakeLock;
...
.method static synthetic zta(Lcom/oneplus/android/server/alertslider/AlertSliderHw;)Lcom/oneplus/android/server/alertslider/AlertSliderHw$you;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->Raa:Lcom/oneplus/android/server/alertslider/AlertSliderHw$you;
...
.method static synthetic zta(Lcom/oneplus/android/server/alertslider/AlertSliderHw;I)V
    ...
    invoke-direct {p0, p1}, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->ec(I)V
...
.method public getState()I
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->Raa:Lcom/oneplus/android/server/alertslider/AlertSliderHw$you;
    ...
    invoke-virtual {p0}, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->He()Z
    ...
    iget-object v10, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->Raa:Lcom/oneplus/android/server/alertslider/AlertSliderHw$you;
    ...
    iget-object v3, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->Raa:Lcom/oneplus/android/server/alertslider/AlertSliderHw$you;
    ...
    iget-object v5, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->Raa:Lcom/oneplus/android/server/alertslider/AlertSliderHw$you;
...
.method public init()Z
    ...
    iget-object v1, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->Saa:Lcom/oneplus/android/server/alertslider/AlertSliderHw$zta;
    ...
    :try_start_1
    iget-object v2, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->Taa:Lcom/oneplus/android/server/alertslider/zta;
    ...
    iput-object v2, p0, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->Taa:Lcom/oneplus/android/server/alertslider/zta;
    ...
    :cond_0
    invoke-direct {p0, v1}, Lcom/oneplus/android/server/alertslider/AlertSliderHw;->ec(I)V
