...
.field private cV:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
            "Ljava/lang/String;",
...
.field dV:Ljava/util/List;

.field eV:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/zta;->bV:Ljava/util/Set;

    new-instance v0, Ljava/util/TreeSet;

    invoke-direct {v0}, Ljava/util/TreeSet;-><init>()V

    iput-object v0, p0, Lcom/oneplus/android/server/zta;->cV:Ljava/util/Set;

    const-string v0, "/system/etc/bluetooth/china_carkit.json"

    iput-object v0, p0, Lcom/oneplus/android/server/zta;->fV:Ljava/lang/String;

    const-string v0, "/data/misc/carkit_user.json"

    iput-object v0, p0, Lcom/oneplus/android/server/zta;->gV:Ljava/lang/String;

    const-string v0, "/data/misc/carkit_cache.json"

    iput-object v0, p0, Lcom/oneplus/android/server/zta;->hV:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/zta;->dV:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/oneplus/android/server/zta;->eV:Ljava/util/List;

    invoke-direct {p0}, Lcom/oneplus/android/server/zta;->oq()V

    invoke-direct {p0}, Lcom/oneplus/android/server/zta;->pq()V

    invoke-direct {p0}, Lcom/oneplus/android/server/zta;->nq()V
...
.method private flush()V
    ...
    iget-object v3, p0, Lcom/oneplus/android/server/zta;->dV:Ljava/util/List;
    ...
    iget-object v4, p0, Lcom/oneplus/android/server/zta;->gV:Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/oneplus/android/server/zta;->eV:Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/zta;->hV:Ljava/lang/String;
...
.method private declared-synchronized nq()V
    ...
    iget-object v3, p0, Lcom/oneplus/android/server/zta;->hV:Ljava/lang/String;
...
.method private oq()V
    ...
    iget-object v3, p0, Lcom/oneplus/android/server/zta;->fV:Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/oneplus/android/server/zta;->bV:Ljava/util/Set;
...
.method private declared-synchronized pq()V
    ...
    iget-object v3, p0, Lcom/oneplus/android/server/zta;->gV:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/oneplus/android/server/zta;->dV:Ljava/util/List;
...
.method private declared-synchronized you(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    :cond_1
    :try_start_1
    iget-object v0, p0, Lcom/oneplus/android/server/zta;->eV:Ljava/util/List;
    ...
    iget-object p1, p0, Lcom/oneplus/android/server/zta;->eV:Ljava/util/List;
...
.method public declared-synchronized addCarkit(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    :try_start_1
    iget-object v0, p0, Lcom/oneplus/android/server/zta;->dV:Ljava/util/List;
    ...
    iget-object p1, p0, Lcom/oneplus/android/server/zta;->dV:Ljava/util/List;
...
.method public declared-synchronized isCarkit(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :goto_1
    :try_start_3
    iget-object v2, p0, Lcom/oneplus/android/server/zta;->eV:Ljava/util/List;
    ...
    :cond_12
    :try_start_8
    iget-object v2, p0, Lcom/oneplus/android/server/zta;->bV:Ljava/util/Set;
