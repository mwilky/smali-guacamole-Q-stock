...
.field private nga:Landroid/widget/LinearLayout;

.field private oga:Landroid/widget/TextView;

.field private pga:Landroid/view/View;

.field private qga:Landroid/view/View;

.field private rga:Landroid/widget/TextView;

.field private sga:Landroid/widget/CheckBox;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/oneplus/android/server/scene/tsu;->wga:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lcom/oneplus/android/server/scene/tsu;->tga:Z

    const/4 v1, 0x0

    iput-object v1, p0, Lcom/oneplus/android/server/scene/tsu;->uga:Lcom/oneplus/android/server/scene/cgv;

    iput-boolean v0, p0, Lcom/oneplus/android/server/scene/tsu;->vga:Z
...
.method static synthetic access$100()Z
    ...
    sget-boolean v0, Lcom/oneplus/android/server/scene/tsu;->wga:Z
...
.method private you(Landroid/view/ViewGroup;)V
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/scene/tsu;->pga:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/scene/tsu;->qga:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/scene/tsu;->oga:Landroid/widget/TextView;

    iget-object v0, p0, Lcom/oneplus/android/server/scene/tsu;->oga:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/scene/tsu;->sga:Landroid/widget/CheckBox;
    ...
    :cond_0
    iget-object v0, p0, Lcom/oneplus/android/server/scene/tsu;->sga:Landroid/widget/CheckBox;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/scene/tsu;->rga:Landroid/widget/TextView;

    iget-object v0, p0, Lcom/oneplus/android/server/scene/tsu;->rga:Landroid/widget/TextView;
...
.method static synthetic zta(Lcom/oneplus/android/server/scene/tsu;)Landroid/widget/CheckBox;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/scene/tsu;->sga:Landroid/widget/CheckBox;
...
.method protected hide()V
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/scene/tsu;->nga:Landroid/widget/LinearLayout;

    if-eqz v0, :cond_1

    :try_start_0
    iget-object v0, p0, Lcom/oneplus/android/server/scene/tsu;->uga:Lcom/oneplus/android/server/scene/cgv;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/oneplus/android/server/scene/tsu;->uga:Lcom/oneplus/android/server/scene/cgv;

    invoke-virtual {v0}, Lcom/oneplus/android/server/scene/cgv;->rf()V

    :cond_0
    iget-object v0, p0, Lcom/oneplus/android/server/scene/tsu;->mWindowManager:Landroid/view/WindowManager;

    iget-object v1, p0, Lcom/oneplus/android/server/scene/tsu;->nga:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/scene/tsu;->nga:Landroid/widget/LinearLayout;
...
.method public isAcquired()Z
    ...
    iget-boolean p0, p0, Lcom/oneplus/android/server/scene/tsu;->vga:Z
...
.method protected declared-synchronized show()V
    ...
    iget-object v2, p0, Lcom/oneplus/android/server/scene/tsu;->nga:Landroid/widget/LinearLayout;
...
.method zta(Landroid/view/ViewGroup;)V
    ...
    invoke-direct {p0, v0}, Lcom/oneplus/android/server/scene/tsu;->qbh(Landroid/content/Context;)Z
    ...
    invoke-direct {p0, p1}, Lcom/oneplus/android/server/scene/tsu;->igw(Landroid/content/Context;)Z
...
.method public zta(Lcom/oneplus/android/server/scene/cgv;)V
    ...
    iput-object p1, p0, Lcom/oneplus/android/server/scene/tsu;->uga:Lcom/oneplus/android/server/scene/cgv;
