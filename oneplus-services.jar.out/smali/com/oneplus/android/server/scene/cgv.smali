...
.field private static final Xga:Ljava/lang/String; = "-1"

.field private static final Yga:Ljava/lang/String; = "android.intent.action.PHONE_STATE"

.field private static final Zga:J = 0x1f4L

.field private static final _ga:Landroid/net/Uri;

.field private static aha:Lcom/oneplus/android/server/scene/vju;

.field private static bha:Lcom/oneplus/android/server/scene/vju;

.field private static cha:Landroid/view/View;


# instance fields
.field private Oga:Landroid/view/WindowManager;

.field private Pga:Landroid/animation/ValueAnimator;

.field private Qga:Landroid/animation/ValueAnimator;

.field private Rga:Lcom/oneplus/android/server/scene/vju;

.field private Sga:Lcom/oneplus/android/server/scene/cgv$zta;

.field private Tga:Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/oneplus/android/server/scene/cgv;->_ga:Landroid/net/Uri;

    const/4 v0, 0x0

    sput-object v0, Lcom/oneplus/android/server/scene/cgv;->aha:Lcom/oneplus/android/server/scene/vju;

    sput-object v0, Lcom/oneplus/android/server/scene/cgv;->bha:Lcom/oneplus/android/server/scene/vju;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/scene/cgv;->Oga:Landroid/view/WindowManager;

    iput-object v0, p0, Lcom/oneplus/android/server/scene/cgv;->Rga:Lcom/oneplus/android/server/scene/vju;

    iput-object v0, p0, Lcom/oneplus/android/server/scene/cgv;->mESportGuider:Lcom/oneplus/android/server/scene/tsu;

    const-string v0, ""

    iput-object v0, p0, Lcom/oneplus/android/server/scene/cgv;->Tga:Ljava/lang/String;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/oneplus/android/server/scene/cgv;->Uga:Z

    iput-boolean v0, p0, Lcom/oneplus/android/server/scene/cgv;->Vga:Z

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lcom/oneplus/android/server/scene/cgv;->Wga:Ljava/util/ArrayList;
    ...
    iput-object p2, p0, Lcom/oneplus/android/server/scene/cgv;->Oga:Landroid/view/WindowManager;
    ...
    iput-object v1, p0, Lcom/oneplus/android/server/scene/cgv;->Pga:Landroid/animation/ValueAnimator;
    ...
    iput-object p2, p0, Lcom/oneplus/android/server/scene/cgv;->Qga:Landroid/animation/ValueAnimator;
    ...
    iput-object p2, p0, Lcom/oneplus/android/server/scene/cgv;->Sga:Lcom/oneplus/android/server/scene/cgv$zta;
    ...
    sget-object p2, Lcom/oneplus/android/server/scene/cgv;->_ga:Landroid/net/Uri;

    iget-object v1, p0, Lcom/oneplus/android/server/scene/cgv;->Sga:Lcom/oneplus/android/server/scene/cgv$zta;
...
.method private Ls()V
    ...
    iget-object v4, p0, Lcom/oneplus/android/server/scene/cgv;->Wga:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/scene/cgv;->Wga:Ljava/util/ArrayList;
...
.method private Os()V
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/scene/cgv;->Rga:Lcom/oneplus/android/server/scene/vju;
    ...
    iget-object v1, p0, Lcom/oneplus/android/server/scene/cgv;->Rga:Lcom/oneplus/android/server/scene/vju;
    ...
    iput-object v1, p0, Lcom/oneplus/android/server/scene/cgv;->Rga:Lcom/oneplus/android/server/scene/vju;
    ...
    iput-object v0, p0, Lcom/oneplus/android/server/scene/cgv;->tb:Landroid/view/WindowManager$LayoutParams;

    iget-object v0, p0, Lcom/oneplus/android/server/scene/cgv;->tb:Landroid/view/WindowManager$LayoutParams;
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/scene/cgv;->Oga:Landroid/view/WindowManager;

    iget-object v1, p0, Lcom/oneplus/android/server/scene/cgv;->Rga:Lcom/oneplus/android/server/scene/vju;

    iget-object v2, p0, Lcom/oneplus/android/server/scene/cgv;->tb:Landroid/view/WindowManager$LayoutParams;
    ...
    invoke-virtual {p0}, Lcom/oneplus/android/server/scene/cgv;->qf()V
...
.method private Qs()V
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/scene/cgv;->Pga:Landroid/animation/ValueAnimator;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/scene/cgv;->Pga:Landroid/animation/ValueAnimator;
...
.method private _a(Z)V
    ...
    iget-object v0, p0, Lcom/oneplus/android/server/scene/cgv;->Qga:Landroid/animation/ValueAnimator;
    ...
    iget-object p1, p0, Lcom/oneplus/android/server/scene/cgv;->Qga:Landroid/animation/ValueAnimator;
    ...
    :cond_0
    iget-object p0, p0, Lcom/oneplus/android/server/scene/cgv;->Qga:Landroid/animation/ValueAnimator;
...
.method private hide(Z)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/oneplus/android/server/scene/cgv;->Rga:Lcom/oneplus/android/server/scene/vju;

    if-eqz p1, :cond_1

    iget-object v1, p0, Lcom/oneplus/android/server/scene/cgv;->Oga:Landroid/view/WindowManager;
    ...
    sput-object v0, Lcom/oneplus/android/server/scene/cgv;->cha:Landroid/view/View;
...
.method static synthetic rtg(Lcom/oneplus/android/server/scene/cgv;)Landroid/view/WindowManager;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/scene/cgv;->Oga:Landroid/view/WindowManager;
...
.method public static sf()I
    ...
    sget-object v0, Lcom/oneplus/android/server/scene/cgv;->cha:Landroid/view/View;
...
.method private show(Z)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/oneplus/android/server/scene/cgv;->Pga:Landroid/animation/ValueAnimator;
...
.method static synthetic sis(Lcom/oneplus/android/server/scene/cgv;)Lcom/oneplus/android/server/scene/vju;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/scene/cgv;->Rga:Lcom/oneplus/android/server/scene/vju;
...
.method static synthetic ssp(Lcom/oneplus/android/server/scene/cgv;)Z
    ...
    iget-boolean p0, p0, Lcom/oneplus/android/server/scene/cgv;->Uga:Z
...
.method static synthetic you(Lcom/oneplus/android/server/scene/cgv;Z)Z
    ...
    iput-boolean p1, p0, Lcom/oneplus/android/server/scene/cgv;->Uga:Z
...
.method static synthetic zta(Lcom/oneplus/android/server/scene/cgv;Lcom/oneplus/android/server/scene/vju;)Lcom/oneplus/android/server/scene/vju;
    ...
    iput-object p1, p0, Lcom/oneplus/android/server/scene/cgv;->Rga:Lcom/oneplus/android/server/scene/vju;
...
.method public O(Z)V
    ...
    iput-boolean p1, p0, Lcom/oneplus/android/server/scene/cgv;->Vga:Z
...
.method public frontPackageChanged(Ljava/lang/String;IILjava/lang/String;II)V
    ...
    :cond_0
    iget-object p2, p0, Lcom/oneplus/android/server/scene/cgv;->Tga:Ljava/lang/String;

    iput-object p1, p0, Lcom/oneplus/android/server/scene/cgv;->Tga:Ljava/lang/String;
    ...
    iget-object p1, p0, Lcom/oneplus/android/server/scene/cgv;->Tga:Ljava/lang/String;
...
.method protected qf()V
    ...
    invoke-direct {p0}, Lcom/oneplus/android/server/scene/cgv;->Qs()V
...
.method public tf()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/oneplus/android/server/scene/cgv;->Tga:Ljava/lang/String;
...
.method public zta(Landroid/content/res/Configuration;)V
    ...
    iget-boolean p1, p0, Lcom/oneplus/android/server/scene/cgv;->Vga:Z
