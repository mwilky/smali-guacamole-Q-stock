...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/oneplus/server/kth;->DEBUG:Z

    const-wide/32 v0, 0x493e0

    sput-wide v0, Lcom/oneplus/server/kth;->screenOffCheckDelayTime:J
...
.method private Pc(Ljava/lang/String;)[Ljava/lang/String;
    ...
    sget-boolean p0, Lcom/oneplus/server/kth;->DEBUG:Z
...
.method static synthetic access$000()J
    ...
    sget-wide v0, Lcom/oneplus/server/kth;->screenOffCheckDelayTime:J
...
.method static synthetic access$200()Landroid/app/AlarmManager;
    ...
    sget-object v0, Lcom/oneplus/server/kth;->mAlarmManager:Landroid/app/AlarmManager;
...
.method public static getInstance()Lcom/oneplus/server/kth;
    ...
    sget-object v0, Lcom/oneplus/server/kth;->mInstance:Lcom/oneplus/server/kth;

    if-nez v0, :cond_0

    new-instance v0, Lcom/oneplus/server/kth;

    invoke-direct {v0}, Lcom/oneplus/server/kth;-><init>()V

    sput-object v0, Lcom/oneplus/server/kth;->mInstance:Lcom/oneplus/server/kth;
...
.method private isMusicPlaying()Z
    ...
    iget-object p0, p0, Lcom/oneplus/server/kth;->mAudioManager:Landroid/media/AudioManager;

    invoke-virtual {p0}, Landroid/media/AudioManager;->isMusicActive()Z

    move-result p0

    sget-boolean v1, Lcom/oneplus/server/kth;->DEBUG:Z
...
.method private st()V
    ...
    iget-object v2, p0, Lcom/oneplus/server/kth;->mAudioManager:Landroid/media/AudioManager;
    ...
    iget-object v1, p0, Lcom/oneplus/server/kth;->mAudioManager:Landroid/media/AudioManager;
...
.method private you(Landroid/content/Context;Lcom/android/server/am/ActivityManagerService;)V
    ...
    iput-object p2, p0, Lcom/oneplus/server/kth;->mActivityManager:Lcom/android/server/am/ActivityManagerService;
    ...
    sput-object p2, Lcom/oneplus/server/kth;->mAlarmManager:Landroid/app/AlarmManager;
    ...
    iput-object p2, p0, Lcom/oneplus/server/kth;->mAudioManager:Landroid/media/AudioManager;
    ...
    sput-object v0, Lcom/oneplus/server/kth;->mScreenOffIntent:Landroid/content/Intent;

    sget-object v0, Lcom/oneplus/server/kth;->mScreenOffIntent:Landroid/content/Intent;
...
.method public static zta(Landroid/content/Context;Lcom/android/server/am/ActivityManagerService;)V
    ...
    invoke-static {}, Lcom/oneplus/server/kth;->getInstance()Lcom/oneplus/server/kth;

    move-result-object v0

    invoke-direct {v0, p0, p1}, Lcom/oneplus/server/kth;->you(Landroid/content/Context;Lcom/android/server/am/ActivityManagerService;)V
