...
.field private static final Pha:Ljava/lang/String; = "android.settings.oneplus_theme_enable"

.field private static final Qha:Ljava/lang/String; = "android.settings.oneplus_theme_disable"

.field private static final Rha:Ljava/lang/String; = "android.settings.oneplus_theme_enable_single"

.field private static final Sha:Ljava/lang/String; = "android.settings.oneplus_theme_disable_single"
...
.field private static final Tha:Ljava/lang/String; = "android.settings.OEM_FONT_MODE"

.field private static final Uha:Ljava/lang/String; = "android.settings.oneplus_basiccolor_ready"

.field private static final Vha:Ljava/lang/String; = "com.oem.intent.action.PKG_ADDED_UPDATED"

.field private static final Wha:Ljava/lang/String; = "android.settings.oneplus_theme_ready"

.field private static final Xha:Ljava/lang/String; = "com.oem.intent.action.parallel_overlay_ready"

.field private static final Yha:Ljava/lang/String; = "persist.sys.theme_first_launch"

.field private static final Zha:Ljava/lang/String; = "persist.sys.theme_version"

.field public static final _ha:I = 0x2

.field public static final aia:I = 0x1

.field public static final bia:I = 0x0

.field private static final cia:Ljava/lang/String; = "oneplus_basiccolor_black"

.field private static final dia:Ljava/lang/String; = "oneplus_basiccolor_white"

.field private static final eia:Ljava/lang/String; = "oneplus_shape_circle"

.field private static final fia:I = 0x1

.field private static gia:Z

.field private static mInstance:Lcom/oneplus/server/zta/sis;


# instance fields
.field private Lha:Landroid/content/om/IOverlayManager;

.field private Mha:Landroid/app/IUiModeManager;

.field private Nha:Landroid/os/IUserManager;

.field private Oha:Landroid/content/BroadcastReceiver;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/oneplus/server/zta/sis;->gia:Z
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/oneplus/server/zta/sis;->Nha:Landroid/os/IUserManager;
    ...
    iput-object p1, p0, Lcom/oneplus/server/zta/sis;->Lha:Landroid/content/om/IOverlayManager;
    ...
    iput-object p1, p0, Lcom/oneplus/server/zta/sis;->Mha:Landroid/app/IUiModeManager;
...
.method private Nc(Ljava/lang/String;)Ljava/util/ArrayList;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    iget-object p0, p0, Lcom/oneplus/server/zta/sis;->Lha:Landroid/content/om/IOverlayManager;
...
.method private Xs()V
    ...
    sget-boolean v0, Lcom/oneplus/server/zta/sis;->gia:Z
    ...
    sput-boolean v1, Lcom/oneplus/server/zta/sis;->gia:Z
...
.method private Zs()V
    ...
    iput-object v0, p0, Lcom/oneplus/server/zta/sis;->Oha:Landroid/content/BroadcastReceiver;
    ...
    iget-object v2, p0, Lcom/oneplus/server/zta/sis;->Oha:Landroid/content/BroadcastReceiver;
    ...
    iget-object p0, p0, Lcom/oneplus/server/zta/sis;->Oha:Landroid/content/BroadcastReceiver;
...
.method private at()Z
    ...
    :try_start_0
    iget-object v2, p0, Lcom/oneplus/server/zta/sis;->Nha:Landroid/os/IUserManager;
    ...
    iget-object p0, p0, Lcom/oneplus/server/zta/sis;->Nha:Landroid/os/IUserManager;
...
.method static synthetic vju(Z)Z
    ...
    sput-boolean p0, Lcom/oneplus/server/zta/sis;->gia:Z
...
.method static synthetic you(Lcom/oneplus/server/zta/sis;)Landroid/app/IUiModeManager;
    ...
    iget-object p0, p0, Lcom/oneplus/server/zta/sis;->Mha:Landroid/app/IUiModeManager;
...
.method static synthetic zta(Lcom/oneplus/server/zta/sis;)I
    ...
    invoke-direct {p0}, Lcom/oneplus/server/zta/sis;->Ys()I
...
.method public Hf()V
    ...
    :cond_0
    invoke-direct {p0}, Lcom/oneplus/server/zta/sis;->_s()Z
...
.method public bio(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p1}, Lcom/oneplus/server/zta/sis;->Nc(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    :try_start_0
    iget-object v2, p0, Lcom/oneplus/server/zta/sis;->Lha:Landroid/content/om/IOverlayManager;
...
.method public enableTheme(Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v3, p0, Lcom/oneplus/server/zta/sis;->Lha:Landroid/content/om/IOverlayManager;
...
.method public processDisableThemeCategory(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0}, Lcom/oneplus/server/zta/sis;->Ws()V
    ...
    invoke-direct {p0, p2}, Lcom/oneplus/server/zta/sis;->Mc(Ljava/lang/String;)V
...
.method public processEnableThemeCategory(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/oneplus/server/zta/sis;->Oc(Ljava/lang/String;)V
