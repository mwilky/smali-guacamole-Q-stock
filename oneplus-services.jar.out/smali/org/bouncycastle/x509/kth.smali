...
.field private Cqa:Lorg/bouncycastle/x509/cno;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lorg/bouncycastle/x509/kth;->xqa:Z

    iput-boolean v0, p0, Lorg/bouncycastle/x509/kth;->yqa:Z

    const/4 v1, 0x0

    iput-object v1, p0, Lorg/bouncycastle/x509/kth;->zqa:Ljava/math/BigInteger;

    iput-object v1, p0, Lorg/bouncycastle/x509/kth;->Aqa:[B

    iput-boolean v0, p0, Lorg/bouncycastle/x509/kth;->Bqa:Z
...
.method public X(Z)V
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/x509/kth;->yqa:Z
...
.method public Y(Z)V
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/x509/kth;->xqa:Z
...
.method public Z(Z)V
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/x509/kth;->Bqa:Z
...
.method public clone()Ljava/lang/Object;
    ...
    iget-boolean v1, p0, Lorg/bouncycastle/x509/kth;->xqa:Z

    iput-boolean v1, v0, Lorg/bouncycastle/x509/kth;->xqa:Z

    iget-boolean v1, p0, Lorg/bouncycastle/x509/kth;->yqa:Z

    iput-boolean v1, v0, Lorg/bouncycastle/x509/kth;->yqa:Z

    iget-object v1, p0, Lorg/bouncycastle/x509/kth;->zqa:Ljava/math/BigInteger;

    iput-object v1, v0, Lorg/bouncycastle/x509/kth;->zqa:Ljava/math/BigInteger;

    iget-object v1, p0, Lorg/bouncycastle/x509/kth;->Cqa:Lorg/bouncycastle/x509/cno;

    iput-object v1, v0, Lorg/bouncycastle/x509/kth;->Cqa:Lorg/bouncycastle/x509/cno;

    iget-boolean v1, p0, Lorg/bouncycastle/x509/kth;->Bqa:Z

    iput-boolean v1, v0, Lorg/bouncycastle/x509/kth;->Bqa:Z

    iget-object p0, p0, Lorg/bouncycastle/x509/kth;->Aqa:[B

    invoke-static {p0}, Lorg/bouncycastle/util/zta;->vdb([B)[B

    move-result-object p0

    iput-object p0, v0, Lorg/bouncycastle/x509/kth;->Aqa:[B
...
.method public cno([B)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/x509/kth;->Aqa:[B
...
.method public match(Ljava/lang/Object;)Z
    ...
    :cond_1
    invoke-virtual {p0}, Lorg/bouncycastle/x509/kth;->sg()Z
    ...
    iget-object v2, p0, Lorg/bouncycastle/x509/kth;->zqa:Ljava/math/BigInteger;

    if-eqz v2, :cond_4

    invoke-virtual {v0}, Lorg/bouncycastle/asn1/ywr;->Sg()Ljava/math/BigInteger;
    ...
    :cond_4
    iget-boolean v0, p0, Lorg/bouncycastle/x509/kth;->Bqa:Z
    ...
    iget-object v2, p0, Lorg/bouncycastle/x509/kth;->Aqa:[B
...
.method public og()Lorg/bouncycastle/x509/cno;
    .locals 0

    iget-object p0, p0, Lorg/bouncycastle/x509/kth;->Cqa:Lorg/bouncycastle/x509/cno;
...
.method public qg()Ljava/math/BigInteger;
    ...
    iget-object p0, p0, Lorg/bouncycastle/x509/kth;->zqa:Ljava/math/BigInteger;
...
.method public rg()Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/x509/kth;->yqa:Z
...
.method public sg()Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/x509/kth;->xqa:Z
...
.method public sis(Ljava/math/BigInteger;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/x509/kth;->zqa:Ljava/math/BigInteger;
...
.method public tg()Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/x509/kth;->Bqa:Z
...
.method public zta(Lorg/bouncycastle/x509/cno;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/x509/kth;->Cqa:Lorg/bouncycastle/x509/cno;
