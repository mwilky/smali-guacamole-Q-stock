...
# instance fields
.field private AGa:Lorg/bouncycastle/asn1/bvj;

.field private EGa:Lorg/bouncycastle/asn1/x509/p;

.field private Gqa:Lorg/bouncycastle/asn1/x509/zta;

.field private final bcHelper:Lorg/bouncycastle/jcajce/tsu/tsu;

.field private jqa:Ljava/lang/String;

.field private final yGa:Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;

.field private zGa:Lorg/bouncycastle/asn1/x509/k;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bouncycastle/x509/oif;->yGa:Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;

    new-instance v0, Lorg/bouncycastle/asn1/x509/k;

    invoke-direct {v0}, Lorg/bouncycastle/asn1/x509/k;-><init>()V

    iput-object v0, p0, Lorg/bouncycastle/x509/oif;->zGa:Lorg/bouncycastle/asn1/x509/k;

    new-instance v0, Lorg/bouncycastle/asn1/x509/p;

    invoke-direct {v0}, Lorg/bouncycastle/asn1/x509/p;-><init>()V

    iput-object v0, p0, Lorg/bouncycastle/x509/oif;->EGa:Lorg/bouncycastle/asn1/x509/p;

    return-void
.end method

.method private Bt()Lorg/bouncycastle/asn1/x509/f;
    .locals 2

    iget-object v0, p0, Lorg/bouncycastle/x509/oif;->EGa:Lorg/bouncycastle/asn1/x509/p;
    ...
    iget-object v0, p0, Lorg/bouncycastle/x509/oif;->zGa:Lorg/bouncycastle/asn1/x509/k;

    iget-object v1, p0, Lorg/bouncycastle/x509/oif;->EGa:Lorg/bouncycastle/asn1/x509/p;
    ...
    :cond_0
    iget-object p0, p0, Lorg/bouncycastle/x509/oif;->zGa:Lorg/bouncycastle/asn1/x509/k;
...
.method private zta(Lorg/bouncycastle/asn1/x509/f;[B)Ljava/security/cert/X509Certificate;
    ...
    iget-object p1, p0, Lorg/bouncycastle/x509/oif;->Gqa:Lorg/bouncycastle/asn1/x509/zta;
    ...
    iget-object p0, p0, Lorg/bouncycastle/x509/oif;->yGa:Lorg/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;
...
.method public hl()Ljava/util/Iterator;
    .locals 0

    invoke-static {}, Lorg/bouncycastle/x509/dma;->gl()Ljava/util/Iterator;
...
.method public reset()V
    ...
    iget-object p0, p0, Lorg/bouncycastle/x509/oif;->EGa:Lorg/bouncycastle/asn1/x509/p;
...
.method public setSignatureAlgorithm(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/x509/oif;->jqa:Ljava/lang/String;

    :try_start_0
    invoke-static {p1}, Lorg/bouncycastle/x509/dma;->Xa(Ljava/lang/String;)Lorg/bouncycastle/asn1/bvj;

    move-result-object v0

    iput-object v0, p0, Lorg/bouncycastle/x509/oif;->AGa:Lorg/bouncycastle/asn1/bvj;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    iget-object v0, p0, Lorg/bouncycastle/x509/oif;->AGa:Lorg/bouncycastle/asn1/bvj;
    ...
    iput-object p1, p0, Lorg/bouncycastle/x509/oif;->Gqa:Lorg/bouncycastle/asn1/x509/zta;

    iget-object p1, p0, Lorg/bouncycastle/x509/oif;->zGa:Lorg/bouncycastle/asn1/x509/k;

    iget-object p0, p0, Lorg/bouncycastle/x509/oif;->Gqa:Lorg/bouncycastle/asn1/x509/zta;
...
.method public you(Ljava/security/PrivateKey;Ljava/security/SecureRandom;)Ljava/security/cert/X509Certificate;
    ...
    invoke-direct {p0}, Lorg/bouncycastle/x509/oif;->Bt()Lorg/bouncycastle/asn1/x509/f;

    move-result-object v0

    :try_start_0
    iget-object v1, p0, Lorg/bouncycastle/x509/oif;->AGa:Lorg/bouncycastle/asn1/bvj;

    iget-object v2, p0, Lorg/bouncycastle/x509/oif;->jqa:Ljava/lang/String;
...
.method public zta(Ljava/security/PrivateKey;Ljava/lang/String;Ljava/security/SecureRandom;)Ljava/security/cert/X509Certificate;
    ...
    iget-object v1, p0, Lorg/bouncycastle/x509/oif;->jqa:Ljava/lang/String;
