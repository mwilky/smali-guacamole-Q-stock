...
.field private zma:Ljava/security/spec/ECParameterSpec;
...
.method protected engineGetEncoded(Ljava/lang/String;)[B
    ...
    invoke-virtual {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->ta(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_2

    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->zma:Ljava/security/spec/ECParameterSpec;
    ...
    :cond_0
    iget-object p0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->Ama:Ljava/lang/String;

    if-eqz p0, :cond_1

    new-instance p1, Lorg/bouncycastle/asn1/ibl/veq;

    invoke-static {p0}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/bio;->Ja(Ljava/lang/String;)Lorg/bouncycastle/asn1/bvj;
    ...
    invoke-virtual {p0}, Lyou/zta/you/you/rtg;->Ii()Ljava/math/BigInteger;

    move-result-object v3

    invoke-virtual {p0}, Lyou/zta/you/you/rtg;->Hi()Ljava/math/BigInteger;
...
.method protected engineGetParameterSpec(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->Ama:Ljava/lang/String;
    ...
    :cond_2
    iget-object p0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->zma:Ljava/security/spec/ECParameterSpec;
...
.method protected engineInit(Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->Ama:Ljava/lang/String;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->Ama:Ljava/lang/String;
    ...
    iput-object v6, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->zma:Ljava/security/spec/ECParameterSpec;
    ...
    :goto_0
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->Ama:Ljava/lang/String;

    check-cast p1, Ljava/security/spec/ECParameterSpec;

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->zma:Ljava/security/spec/ECParameterSpec;
...
.method protected engineInit([BLjava/lang/String;)V
    ...
    invoke-virtual {p0, p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->ta(Ljava/lang/String;)Z
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/asn1/ibl/veq;->Di()Z
    ...
    iput-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ec/zta;->Ama:Ljava/lang/String;
