...
# instance fields
.field private final Qna:I

.field private final Rna:Z

.field private final bCa:Ljava/security/cert/PKIXParameters;

.field private final cCa:Lorg/bouncycastle/jcajce/cno;

.field private final dCa:Ljava/util/List;
...
.field private final eCa:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
...
.field private final fCa:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
.field private final hCa:Z

.field private final iCa:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
...
.method private constructor <init>(Lorg/bouncycastle/jcajce/wtn$zta;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn;->bCa:Ljava/security/cert/PKIXParameters;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn;->dCa:Ljava/util/List;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn;->eCa:Ljava/util/Map;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/wtn;->fCa:Ljava/util/List;
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/wtn;->iCa:Ljava/util/Set;
...
.method static synthetic bio(Lorg/bouncycastle/jcajce/wtn;)I
    ...
    iget p0, p0, Lorg/bouncycastle/jcajce/wtn;->Qna:I
...
.method static synthetic cno(Lorg/bouncycastle/jcajce/wtn;)Ljava/util/Map;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->gCa:Ljava/util/Map;
...
.method static synthetic kth(Lorg/bouncycastle/jcajce/wtn;)Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/jcajce/wtn;->Rna:Z
...
.method static synthetic rtg(Lorg/bouncycastle/jcajce/wtn;)Ljava/util/Map;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->eCa:Ljava/util/Map;
...
.method static synthetic sis(Lorg/bouncycastle/jcajce/wtn;)Lorg/bouncycastle/jcajce/cno;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->cCa:Lorg/bouncycastle/jcajce/cno;
...
.method static synthetic ssp(Lorg/bouncycastle/jcajce/wtn;)Ljava/util/List;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->fCa:Ljava/util/List;
...
.method static synthetic tsu(Lorg/bouncycastle/jcajce/wtn;)Ljava/util/List;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->dCa:Ljava/util/List;
...
.method static synthetic zta(Lorg/bouncycastle/jcajce/wtn;)Ljava/security/cert/PKIXParameters;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->bCa:Ljava/security/cert/PKIXParameters;
...
# virtual methods
.method public Zf()Lorg/bouncycastle/jcajce/cno;
    .locals 0
...
.method public getTrustAnchors()Ljava/util/Set;
    ...
    iget-object p0, p0, Lorg/bouncycastle/jcajce/wtn;->iCa:Ljava/util/Set;
...
.method public isRevocationEnabled()Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/jcajce/wtn;->hCa:Z
...
.method public vj()Ljava/util/Map;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
