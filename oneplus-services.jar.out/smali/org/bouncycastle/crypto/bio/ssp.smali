...
.field private static final uDa:J = 0xfffffffe0L
...
.field private gDa:Lorg/bouncycastle/crypto/bio/zta/sis;

.field private gpa:Z

.field private hDa:Lorg/bouncycastle/crypto/bio/zta/you;
...
.method public constructor <init>(Lorg/bouncycastle/crypto/rtg;Lorg/bouncycastle/crypto/bio/zta/sis;)V
    ...
    :cond_0
    iput-object p1, p0, Lorg/bouncycastle/crypto/bio/ssp;->Rpa:Lorg/bouncycastle/crypto/rtg;

    iput-object p2, p0, Lorg/bouncycastle/crypto/bio/ssp;->gDa:Lorg/bouncycastle/crypto/bio/zta/sis;
...
.method private Wt()V
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->gpa:Z

    if-nez v0, :cond_1

    iget-boolean p0, p0, Lorg/bouncycastle/crypto/bio/ssp;->Aza:Z
...
.method private Xt()V
    ...
    iget-wide v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->sDa:J
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->mDa:[B

    iget-object v5, p0, Lorg/bouncycastle/crypto/bio/ssp;->nDa:[B

    invoke-static {v0, v4, v5, v4, v1}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget-wide v5, p0, Lorg/bouncycastle/crypto/bio/ssp;->sDa:J

    iput-wide v5, p0, Lorg/bouncycastle/crypto/bio/ssp;->tDa:J

    :cond_0
    iget v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->rDa:I

    if-lez v0, :cond_1

    iget-object v5, p0, Lorg/bouncycastle/crypto/bio/ssp;->nDa:[B

    iget-object v6, p0, Lorg/bouncycastle/crypto/bio/ssp;->qDa:[B

    invoke-direct {p0, v5, v6, v4, v0}, Lorg/bouncycastle/crypto/bio/ssp;->you([B[BII)V

    iget-wide v5, p0, Lorg/bouncycastle/crypto/bio/ssp;->tDa:J
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->nDa:[B
...
.method private fd(I)J
    .locals 4

    iget-wide v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->pDa:J

    int-to-long v2, p1

    add-long/2addr v0, v2

    iget p0, p0, Lorg/bouncycastle/crypto/bio/ssp;->zza:I
...
.method private gwm([B[B)V
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/bio/ssp;->gDa:Lorg/bouncycastle/crypto/bio/zta/sis;
...
.method private ivd([B)V
    ...
    iget v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->oDa:I

    if-eqz v0, :cond_0

    add-int/lit8 v0, v0, -0x1

    iput v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->oDa:I
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/bio/ssp;->Rpa:Lorg/bouncycastle/crypto/rtg;
...
.method private reset(Z)V
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->Rpa:Lorg/bouncycastle/crypto/rtg;
    ...
    iput-object v1, p0, Lorg/bouncycastle/crypto/bio/ssp;->mDa:[B

    new-array v1, v0, [B

    iput-object v1, p0, Lorg/bouncycastle/crypto/bio/ssp;->nDa:[B

    new-array v0, v0, [B

    iput-object v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->qDa:[B

    const/4 v0, 0x0

    iput v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->rDa:I

    const-wide/16 v1, 0x0

    iput-wide v1, p0, Lorg/bouncycastle/crypto/bio/ssp;->sDa:J

    iput-wide v1, p0, Lorg/bouncycastle/crypto/bio/ssp;->tDa:J

    iget-object v3, p0, Lorg/bouncycastle/crypto/bio/ssp;->kDa:[B
    ...
    iput v3, p0, Lorg/bouncycastle/crypto/bio/ssp;->oDa:I

    iput v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->zza:I

    iput-wide v1, p0, Lorg/bouncycastle/crypto/bio/ssp;->pDa:J

    iget-object v1, p0, Lorg/bouncycastle/crypto/bio/ssp;->lDa:[B
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/bio/ssp;->eDa:[B

    :cond_1
    iget-boolean p1, p0, Lorg/bouncycastle/crypto/bio/ssp;->Aza:Z

    if-eqz p1, :cond_2

    iput-boolean v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->gpa:Z

    goto :goto_0

    :cond_2
    iget-object p1, p0, Lorg/bouncycastle/crypto/bio/ssp;->cDa:[B
...
.method private sis([BII[BI)V
    ...
    iget-boolean v1, p0, Lorg/bouncycastle/crypto/bio/ssp;->Aza:Z
    ...
    iget-wide p1, p0, Lorg/bouncycastle/crypto/bio/ssp;->pDa:J

    int-to-long p3, p3

    add-long/2addr p1, p3

    iput-wide p1, p0, Lorg/bouncycastle/crypto/bio/ssp;->pDa:J
...
.method private zta([BI[BI)V
    ...
    iget-wide v2, p0, Lorg/bouncycastle/crypto/bio/ssp;->pDa:J
    ...
    invoke-direct {p0}, Lorg/bouncycastle/crypto/bio/ssp;->Xt()V
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->Aza:Z
...
.method public doFinal([BI)I
    ...
    :cond_0
    iget v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->zza:I
    ...
    iget v5, p0, Lorg/bouncycastle/crypto/bio/ssp;->RCa:I
    ...
    :cond_2
    iget v1, p0, Lorg/bouncycastle/crypto/bio/ssp;->RCa:I
    ...
    iget-object v6, p0, Lorg/bouncycastle/crypto/bio/ssp;->lDa:[B
    ...
    :cond_3
    iget-wide v4, p0, Lorg/bouncycastle/crypto/bio/ssp;->sDa:J

    iget v1, p0, Lorg/bouncycastle/crypto/bio/ssp;->rDa:I

    int-to-long v6, v1

    add-long/2addr v4, v6

    iput-wide v4, p0, Lorg/bouncycastle/crypto/bio/ssp;->sDa:J

    iget-wide v4, p0, Lorg/bouncycastle/crypto/bio/ssp;->sDa:J

    iget-wide v6, p0, Lorg/bouncycastle/crypto/bio/ssp;->tDa:J
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/bio/ssp;->mDa:[B

    iget-object v9, p0, Lorg/bouncycastle/crypto/bio/ssp;->qDa:[B

    invoke-direct {p0, v4, v9, v8, v1}, Lorg/bouncycastle/crypto/bio/ssp;->you([B[BII)V

    :cond_4
    iget-wide v9, p0, Lorg/bouncycastle/crypto/bio/ssp;->tDa:J

    cmp-long v1, v9, v2

    if-lez v1, :cond_5

    iget-object v1, p0, Lorg/bouncycastle/crypto/bio/ssp;->mDa:[B

    iget-object v2, p0, Lorg/bouncycastle/crypto/bio/ssp;->nDa:[B

    invoke-static {v1, v2}, Lorg/bouncycastle/crypto/bio/zta/tsu;->you([B[B)V

    :cond_5
    iget-wide v1, p0, Lorg/bouncycastle/crypto/bio/ssp;->pDa:J
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/bio/ssp;->hDa:Lorg/bouncycastle/crypto/bio/zta/you;
    ...
    iput-object v4, p0, Lorg/bouncycastle/crypto/bio/ssp;->hDa:Lorg/bouncycastle/crypto/bio/zta/you;

    iget-object v4, p0, Lorg/bouncycastle/crypto/bio/ssp;->hDa:Lorg/bouncycastle/crypto/bio/zta/you;

    iget-object v9, p0, Lorg/bouncycastle/crypto/bio/ssp;->jDa:[B
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/bio/ssp;->mDa:[B
    ...
    iget-wide v2, p0, Lorg/bouncycastle/crypto/bio/ssp;->sDa:J
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/bio/ssp;->Rpa:Lorg/bouncycastle/crypto/rtg;
    ...
    iget v2, p0, Lorg/bouncycastle/crypto/bio/ssp;->RCa:I

    new-array v3, v2, [B

    iput-object v3, p0, Lorg/bouncycastle/crypto/bio/ssp;->eDa:[B

    iget-object v3, p0, Lorg/bouncycastle/crypto/bio/ssp;->eDa:[B
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/bio/ssp;->eDa:[B

    iget v2, p0, Lorg/bouncycastle/crypto/bio/ssp;->zza:I
    ...
    iget p1, p0, Lorg/bouncycastle/crypto/bio/ssp;->RCa:I
    ...
    iget-object p1, p0, Lorg/bouncycastle/crypto/bio/ssp;->eDa:[B
...
.method public getMac()[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->eDa:[B

    if-nez v0, :cond_0

    iget p0, p0, Lorg/bouncycastle/crypto/bio/ssp;->RCa:I
...
.method public sis([BII)V
    ...
    invoke-direct {p0, p3}, Lorg/bouncycastle/crypto/bio/ssp;->fd(I)J
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/bio/ssp;->qDa:[B

    iget v3, p0, Lorg/bouncycastle/crypto/bio/ssp;->rDa:I
    ...
    iput v3, p0, Lorg/bouncycastle/crypto/bio/ssp;->rDa:I

    const/16 v4, 0x10

    if-ne v3, v4, :cond_0

    iget-object v3, p0, Lorg/bouncycastle/crypto/bio/ssp;->mDa:[B
    ...
    iput-wide v2, p0, Lorg/bouncycastle/crypto/bio/ssp;->sDa:J
...
.method public zta(B[BI)I
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/crypto/bio/ssp;->fd(I)J
    ...
    iput v2, p0, Lorg/bouncycastle/crypto/bio/ssp;->zza:I
    ...
    :cond_0
    iget-object p1, p0, Lorg/bouncycastle/crypto/bio/ssp;->lDa:[B

    iget p3, p0, Lorg/bouncycastle/crypto/bio/ssp;->RCa:I

    invoke-static {p1, p2, p1, v0, p3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget p1, p0, Lorg/bouncycastle/crypto/bio/ssp;->RCa:I

    iput p1, p0, Lorg/bouncycastle/crypto/bio/ssp;->zza:I
...
.method public zta([BII[BI)I
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->lDa:[B

    iget v3, p0, Lorg/bouncycastle/crypto/bio/ssp;->zza:I
    ...
    iput v3, p0, Lorg/bouncycastle/crypto/bio/ssp;->zza:I
    ...
    iget-object p4, p0, Lorg/bouncycastle/crypto/bio/ssp;->lDa:[B

    invoke-static {p1, p2, p4, v2, p3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iput p3, p0, Lorg/bouncycastle/crypto/bio/ssp;->zza:I
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/bio/ssp;->lDa:[B

    iget v5, p0, Lorg/bouncycastle/crypto/bio/ssp;->zza:I
    ...
    iput v5, p0, Lorg/bouncycastle/crypto/bio/ssp;->zza:I
    ...
    iget v4, p0, Lorg/bouncycastle/crypto/bio/ssp;->RCa:I

    iput v4, p0, Lorg/bouncycastle/crypto/bio/ssp;->zza:I
...
.method public zta(B)V
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/bio/ssp;->qDa:[B

    iget v2, p0, Lorg/bouncycastle/crypto/bio/ssp;->rDa:I

    aput-byte p1, v1, v2

    add-int/2addr v2, v0

    iput v2, p0, Lorg/bouncycastle/crypto/bio/ssp;->rDa:I

    const/16 p1, 0x10

    if-ne v2, p1, :cond_0

    iget-object p1, p0, Lorg/bouncycastle/crypto/bio/ssp;->mDa:[B

    invoke-direct {p0, p1, v1}, Lorg/bouncycastle/crypto/bio/ssp;->gwm([B[B)V

    const/4 p1, 0x0

    iput p1, p0, Lorg/bouncycastle/crypto/bio/ssp;->rDa:I
    ...
    iput-wide v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->sDa:J
...
.method public zta(ZLorg/bouncycastle/crypto/kth;)V
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/crypto/bio/ssp;->Aza:Z

    const/4 v0, 0x0

    iput-object v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->eDa:[B

    const/4 v1, 0x1

    iput-boolean v1, p0, Lorg/bouncycastle/crypto/bio/ssp;->gpa:Z
    ...
    invoke-virtual {p2}, Lorg/bouncycastle/crypto/wtn/zta;->sj()[B

    move-result-object v5

    iput-object v5, p0, Lorg/bouncycastle/crypto/bio/ssp;->cDa:[B
    ...
    iput v5, p0, Lorg/bouncycastle/crypto/bio/ssp;->RCa:I
    ...
    iput-object v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->cDa:[B

    iput v4, p0, Lorg/bouncycastle/crypto/bio/ssp;->RCa:I
    ...
    iput-object v5, p0, Lorg/bouncycastle/crypto/bio/ssp;->lDa:[B
    ...
    iget-object v5, p0, Lorg/bouncycastle/crypto/bio/ssp;->iDa:[B
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/bio/ssp;->iDa:[B
    ...
    iput-object p2, p0, Lorg/bouncycastle/crypto/bio/ssp;->jDa:[B

    iget-object p2, p0, Lorg/bouncycastle/crypto/bio/ssp;->Rpa:Lorg/bouncycastle/crypto/rtg;

    iget-object v2, p0, Lorg/bouncycastle/crypto/bio/ssp;->jDa:[B

    invoke-interface {p2, v2, p1, v2, p1}, Lorg/bouncycastle/crypto/rtg;->zta([BI[BI)I

    iget-object p2, p0, Lorg/bouncycastle/crypto/bio/ssp;->gDa:Lorg/bouncycastle/crypto/bio/zta/sis;

    iget-object v2, p0, Lorg/bouncycastle/crypto/bio/ssp;->jDa:[B

    invoke-interface {p2, v2}, Lorg/bouncycastle/crypto/bio/zta/sis;->init([B)V

    iput-object v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->hDa:Lorg/bouncycastle/crypto/bio/zta/you;

    goto :goto_3

    :cond_7
    iget-object p2, p0, Lorg/bouncycastle/crypto/bio/ssp;->jDa:[B
    ...
    iput-object p2, p0, Lorg/bouncycastle/crypto/bio/ssp;->kDa:[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->kDa:[B

    array-length v2, p2

    invoke-static {p2, p1, v0, p1, v2}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget-object p2, p0, Lorg/bouncycastle/crypto/bio/ssp;->kDa:[B
    ...
    iput-object p2, p0, Lorg/bouncycastle/crypto/bio/ssp;->mDa:[B

    new-array p2, v4, [B

    iput-object p2, p0, Lorg/bouncycastle/crypto/bio/ssp;->nDa:[B

    new-array p2, v4, [B

    iput-object p2, p0, Lorg/bouncycastle/crypto/bio/ssp;->qDa:[B
    ...
    iput-wide v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->tDa:J
    ...
    iput p2, p0, Lorg/bouncycastle/crypto/bio/ssp;->oDa:I

    iput p1, p0, Lorg/bouncycastle/crypto/bio/ssp;->zza:I

    iput-wide v0, p0, Lorg/bouncycastle/crypto/bio/ssp;->pDa:J

    iget-object p2, p0, Lorg/bouncycastle/crypto/bio/ssp;->cDa:[B
