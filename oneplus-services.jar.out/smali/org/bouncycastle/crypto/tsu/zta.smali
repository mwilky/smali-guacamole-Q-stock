...
.field private UAa:Lorg/bouncycastle/crypto/qbh;
...
.method public constructor <init>(Lorg/bouncycastle/crypto/zta;Lorg/bouncycastle/crypto/qbh;Lorg/bouncycastle/crypto/qbh;[B)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/tsu/zta;->fpa:Lorg/bouncycastle/crypto/zta;

    iput-object p3, p0, Lorg/bouncycastle/crypto/tsu/zta;->UAa:Lorg/bouncycastle/crypto/qbh;
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/tsu/zta;->TAa:[B
    ...
    :cond_0
    iget-object p0, p0, Lorg/bouncycastle/crypto/tsu/zta;->TAa:[B
...
.method private zta([BIII)[B
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/tsu/zta;->UAa:Lorg/bouncycastle/crypto/qbh;
    ...
    iget-object v3, p0, Lorg/bouncycastle/crypto/tsu/zta;->UAa:Lorg/bouncycastle/crypto/qbh;
    ...
    iget-object v5, p0, Lorg/bouncycastle/crypto/tsu/zta;->UAa:Lorg/bouncycastle/crypto/qbh;
    ...
    iget-object p4, p0, Lorg/bouncycastle/crypto/tsu/zta;->UAa:Lorg/bouncycastle/crypto/qbh;

    invoke-interface {p4, p1, p2, p3}, Lorg/bouncycastle/crypto/qbh;->update([BII)V

    iget-object p1, p0, Lorg/bouncycastle/crypto/tsu/zta;->UAa:Lorg/bouncycastle/crypto/qbh;

    array-length p2, v2

    invoke-interface {p1, v2, v3, p2}, Lorg/bouncycastle/crypto/qbh;->update([BII)V

    iget-object p0, p0, Lorg/bouncycastle/crypto/tsu/zta;->UAa:Lorg/bouncycastle/crypto/qbh;
...
.method public b()Lorg/bouncycastle/crypto/zta;
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/tsu/zta;->fpa:Lorg/bouncycastle/crypto/zta;
...
.method public d()I
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/tsu/zta;->fpa:Lorg/bouncycastle/crypto/zta;

    invoke-interface {v0}, Lorg/bouncycastle/crypto/zta;->d()I

    move-result v0

    iget-boolean v1, p0, Lorg/bouncycastle/crypto/tsu/zta;->Aza:Z
...
.method public rtg([BII)[B
    ...
    iget-object p2, p0, Lorg/bouncycastle/crypto/tsu/zta;->fpa:Lorg/bouncycastle/crypto/zta;
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/tsu/zta;->TAa:[B
    ...
    :goto_1
    iget-object p1, p0, Lorg/bouncycastle/crypto/tsu/zta;->TAa:[B
    ...
    :goto_2
    iget-object v3, p0, Lorg/bouncycastle/crypto/tsu/zta;->TAa:[B
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/tsu/zta;->TAa:[B
...
.method public ssp([BII)[B
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/tsu/zta;->TAa:[B
    ...
    iget-object p2, p0, Lorg/bouncycastle/crypto/tsu/zta;->Xoa:Ljava/security/SecureRandom;
    ...
    iget-object p3, p0, Lorg/bouncycastle/crypto/tsu/zta;->TAa:[B
    ...
    :cond_0
    iget-object p2, p0, Lorg/bouncycastle/crypto/tsu/zta;->TAa:[B
...
.method public you([BII)[B
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/crypto/tsu/zta;->Aza:Z
...
.method public zta(ZLorg/bouncycastle/crypto/kth;)V
    ...
    :goto_0
    iput-object v0, p0, Lorg/bouncycastle/crypto/tsu/zta;->Xoa:Ljava/security/SecureRandom;

    iget-object v0, p0, Lorg/bouncycastle/crypto/tsu/zta;->fpa:Lorg/bouncycastle/crypto/zta;

    invoke-interface {v0, p1, p2}, Lorg/bouncycastle/crypto/zta;->zta(ZLorg/bouncycastle/crypto/kth;)V

    iput-boolean p1, p0, Lorg/bouncycastle/crypto/tsu/zta;->Aza:Z
